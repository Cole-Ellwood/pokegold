...
; Johto story events
	...
	const EVENT_GOT_TM39_DOUBLE_EDGE_FROM_MOOMOO_FARM
	...
	const EVENT_GOT_TM_REST_FROM_ROUTE31
...
; Johto hidden items
	...
	const EVENT_SILVER_CAVE_ROOM_1_HIDDEN_MAX_ELIXER
...
; Kanto hidden items
	...
	const EVENT_UNDERGROUND_PATH_HIDDEN_MAX_ETHER
	const EVENT_ROCK_TUNNEL_1F_HIDDEN_STARDUST
	const EVENT_ROCK_TUNNEL_1F_HIDDEN_NUGGET
	...
	const EVENT_MOUNT_MOON_SQUARE_HIDDEN_BIG_PEARL
...
; Johto itemballs
	...
	const EVENT_LAKE_OF_RAGE_EVOLITE
	const EVENT_SPROUT_TOWER_1F_PARLYZ_HEAL
	const EVENT_SPROUT_TOWER_2F_ANTIDOTE
	...
	const EVENT_BURNED_TOWER_1F_SUPER_POTION
	...
	const EVENT_UNION_CAVE_1F_ESCAPE_ROPE
	const EVENT_UNION_CAVE_1F_AWAKENING
	const EVENT_UNION_CAVE_B1F_MUSCLE_BAND
	const EVENT_UNION_CAVE_B1F_AWAKENING
	...
	const EVENT_TEAM_ROCKET_BASE_B1F_REVIVE
	...
	const EVENT_MOUNT_MORTAR_1F_OUTSIDE_SUPER_REPEL
	...
	const EVENT_WHIRL_ISLAND_SW_MAX_POTION
	...
	const EVENT_SILVER_CAVE_ROOM_1_MAX_REVIVE
	...
	const EVENT_DARK_CAVE_BLACKTHORN_ENTRANCE_CHOICE_SCARF
	...
	const EVENT_VICTORY_ROAD_MAX_ETHER
	const EVENT_DRAGONS_DEN_B1F_DRAGON_FANG
	const EVENT_TOHJO_FALLS_NUGGET
...
; Johto people
	...
	const EVENT_RESERVED_TM_TUTOR_UNLOCKED ; RESERVED_UNUSED: keep slot allocated for event flag numbering stability
	const EVENT_RESERVED_TM_TUTOR_UNLIMITED ; RESERVED_UNUSED: keep slot allocated for event flag numbering stability
	...
	const EVENT_RESERVED_FEATURE_CLEANUP_1205
...
; Kanto itemballs
	...
	const EVENT_ROUTE_2_SUPER_POTION
