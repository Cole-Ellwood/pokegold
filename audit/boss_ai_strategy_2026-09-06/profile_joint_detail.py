    ...
    with open_harness(args.rom) as h:
        ...
        def invoke(name, regs=None, **kwargs):
            ...
            labels = {
                ...
                "scale": "BossAI_DamageKernel.Scale",
                "preroll": "BossAI_DamageKernel.PreRoll",
                "formula": "BossAI_DamageKernel.Formula",
                "rawquotient": "BossAI_DamageKernel.RawQuotient",
                "passives": "BossAI_DamageKernel.Passives",
                "variation": "BossAI_DamageKernel.variation",
                "move_priority": "BossAI_PublicMovePriority",
                "load_outgoing": "BossAI_ValuePublicExchange.LoadPreparedOutgoing",
                "own_move": "BossAI_ValuePublicExchange.OwnMove",
                "reply_move": "BossAI_ValuePublicExchange.Reply",
                "eval_branch": "BossAI_ComparePublicActions.EvaluateBranch",
                "eval_reply": "BossAI_ComparePublicActions.EvaluateReply",
                "get_far_byte": "GetFarByte",
                "build_incoming": "BossAI_BuildPreparedIncoming",
                "hit_accuracy": "BossAI_PublicHitFacts.accuracy",
                "prepare_hp_values": "BossAI_PrepareHPValues",
                "candidates": "BossAI_EnumeratePublicActions",
                "reply_set": "BossAI_BuildPublicReplySet",
            ...
            def on_label(key):
                ...
                if key in ("exchange", "prepare_reply", "owned_context", "damage_range", "player_stat", "hit_facts", "speed_facts",
                           ...
                           "scale","preroll","formula","rawquotient","passives","variation","move_priority","load_outgoing","own_move","reply_move",
                           "eval_branch","eval_reply","get_far_byte","build_incoming","hit_accuracy","prepare_hp_values","candidates","reply_set"):
