...
- Generated: 2026-05-30T03:54:09Z
...
| --- | --- | --- | --- |
| deity_nav_morty_turn3 | 1 | FAIL | proof command exited 2 (capability not built / could not self-drive) |
| deity_nav_first_wild_route29 | 1 | FAIL | proof command exited 2 (capability not built / could not self-drive) |
