...
PHASES = {
    ...
    PROTOTYPE + ".OwnVariants": "owned_prepare",
    PROTOTYPE + ".PreparePlanPairs": "owned_prepare",
    PROTOTYPE + ".CommitPairs": "orchestration",
    PROTOTYPE + ".PlainStandalone": "scalar_standalone",
    PROTOTYPE + ".FastPair": "scalar_pair",
    PROTOTYPE + ".IdentityPair": "native_pair",
    PROTOTYPE + ".BoostPair": "native_pair",
    PROTOTYPE + ".OwnBoostPair": "native_pair",
    "BossAI_FastFallbackPairNativeFar": "native_pair",
    "BossAI_FastFallbackPairCorrectionFar": "fallback_pair",
    ...
    "BossAI_FastCompileReplyVariants": "reply_compile_native",
