...
def build_parser() -> argparse.ArgumentParser:
    ...
    taint.add_argument("--byte", default="", help="deity auto-taint byte/symbol target, e.g. wCurDamage or $D141")
    taint.add_argument("--at", default="", help="deity auto-taint target-state predicate")
    ...
    watch.add_argument("--live", action="store_true", help="start the deity live-view stream")
    watch.add_argument("--headless", action="store_true", help="emit the live-view stream without an interactive TUI")
    watch.add_argument("--at", default="", help="target-state predicate for --live")
    watch.add_argument("--breakpoint", default="", help="reserved live-view breakpoint target")
    watch.add_argument("--snapshot", default="", help="write a static JSON snapshot from the live stream")
