...
DISPROOF_STANDARDS = {
    ...
    "headless_battle_simulation": [
        "If the report claims strategic automatic full-battle action choice, automatic trainer item usage, player trainer-battle Pack availability, inventory accounting, implicit replacement without auto_replace_or or auto_replace, Pursuit/Spikes/switch-in effects, link-battle turn-order inversion, stage-changing move effects, accuracy/evasion modifiers, Baton Pass/Psych Up, badge boosts, status speed, passive stat/speed/accuracy bonuses, status application or sleep/freeze/paralysis, RNG-consuming mechanics outside the listed supported branch points, live Boss AI scoring, scripts, or byte-proven turn sequencing beyond the listed coverage labels, reject the route as overclaimed.",
    ],
    "type_chart_navigation": [
