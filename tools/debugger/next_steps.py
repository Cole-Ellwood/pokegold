...
NEXT_STEP_ROWS = [
    ...
    {
        "symptom_class": "damage_clobber_regression",
        "matched_lane": "damage_chain",
        "title": "Damage magnitude wrong (Nx too high/low) -- register-clobber regression class",
        "keywords": [
            "5x",
            "too much damage",
            "damage too high",
        ...
        "required_inputs": [
            "none; clobber_smoke runs the curated damage-chain scenarios against the built ROM",
        ],
        "proof_limit": "Multi-scenario damage-chain regression smoke; for a specific matchup also run `python -m tools.damage_debugger.find <scenario>` and `consequence --file <touched-asm>` to localize the clobbering write.",
        "escalation_command": "python -m tools.debugger consequence --file engine/battle/late_gen_held_items.asm",
    },
    {
