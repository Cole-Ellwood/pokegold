...
NEXT_STEP_ROWS = [
    ...
    },
    {
        ...
        "required_inputs": ["scenario JSON with active mons, stats or species shorthand, selected actions or turns[], and fixed/sample/exhaustive RNG for damage variation"],
        "proof_limit": "Selected-action slice: move-vs-move priority/unequal-raw-speed order, damage variation with fixed/sample/exhaustive RNG, multi-turn turns[] progression with HP/RNG carryover, pre-variation damage delegated to the existing ROM-backed damage oracle, and post-score Boss AI selector replay from known score bytes. Automatic full battle choice, switch/replacement flow, speed ties, accuracy, status, RNG-consuming mechanics outside damage variation, live Boss AI scoring, and scripts remain out of scope until separately implemented and proven.",
...
EVIDENCE_STANDARDS = {
    ...
    "headless_battle_simulation": [
        "The answer routes to tools.headless_battle, uses a JSON state/actions-or-turns/RNG scenario, and preserves proof labels: pre-variation damage is delegated to the existing ROM-backed damage oracle, damage variation has fixed/sample/exhaustive RNG branching, selected-turn priority/unequal-raw-speed order is source-mirrored, selected-action turns[] progression carries HP/RNG state, post-score Boss AI selector replay starts from known score bytes, and unimplemented RNG/full-battle mechanics remain out of scope.",
    ],
    "type_chart_navigation": [
...
DISPROOF_STANDARDS = {
    ...
    "headless_battle_simulation": [
        "If the report claims automatic full battle choice, switch/replacement flow, speed ties, RNG-consuming mechanics outside damage variation, accuracy, status, live Boss AI scoring, scripts, or byte-proven turn sequencing beyond the listed coverage labels, reject the route as overclaimed.",
    ],
    "type_chart_navigation": [
