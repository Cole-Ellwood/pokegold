...
DISPROOF_STANDARDS = {
    ...
    "headless_battle_simulation": [
        "If the report claims strategic automatic full-battle action choice, automatic trainer item usage, player trainer-battle Pack availability, inventory accounting, implicit replacement without auto_replace_or or auto_replace, Pursuit/Spikes/switch-in effects, link-battle turn-order inversion, accuracy/evasion stage moves/modifiers, damaging secondary stat effects outside selected burn/poison/paralysis status secondaries, multi-stat chains outside Dragon Dance/Calm Mind/Quiver Dance, Baton Pass/Psych Up, Substitute/Mist blockers, badge boosts, passive stat/speed/accuracy bonuses outside the listed paralysis path, status application outside selected poison/paralysis/sleep-status moves and selected damaging status secondaries, sleep mechanics outside selected sleep moves/Rest/action denial, freeze, burn application outside selected damaging burn secondaries, Safeguard/Substitute, held status prevent/cure item consumption, non-paralyzed Electric speed passives, weather/time healing, drain effects outside selected EFFECT_LEECH_HIT moves, Heal Bell, RNG-consuming mechanics outside the listed supported branch points, live Boss AI scoring, scripts, or byte-proven turn sequencing beyond the listed coverage labels, reject the route as overclaimed.",
    ],
    "type_chart_navigation": [
