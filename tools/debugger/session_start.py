...
Single-command summary so a fresh session can orient in seconds without
learning every subsystem CLI. Composes existing v2 surfaces — selftest,
hypothesis tracker, git log — into a bounded readout.

Acceptance contract (2026-05-21)
--------------------------------
