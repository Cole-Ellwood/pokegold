    ...
    *,
    ...
    return {
        ...
        "known_limits": [
            ...
            "Observed bus addresses are indexed separately from bank-qualified requested addresses so subsequent runtime bank probes can attach exact WRAMX/SRAM/VRAM bank provenance.",
        ],
    }
