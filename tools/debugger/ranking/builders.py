"""Per-report-kind finding builders.

Each ``*_findings(report, *, source)`` accepts a unified-debugger report dict
of a known ``kind`` and returns a list of finding dicts. The dispatch table
that maps ``kind`` -> builder lives in ``__init__.py``.
"""
...
from .helpers import dict_items, finding, string_items, unique_string_items
from .severity import SEVERITY_BASE
