...
MASTERY_POLICY_CASES = [
    ...
    },
    {
        ...
        "expectation": {
            ...
            "condition_tags": ["named_receiver_branch", "status_absorber_named"],
            "lesson_type": "policy_card",
            "confidence": "medium",
    ...
    },
    {
        ...
        "expectation": {
            ...
            "condition_tags": ["support_job_completed", "active_target_already_statused"],
            "lesson_type": "policy_card",
            "confidence": "medium",
