...
| Cheap difficulty audit | Do losses feel deserved, or did the designer punish trust in the game? | `docs/codex_review_playbook.md`, `docs/project_roadmap.md` |
...
| Battle-system correctness | Are custom mechanics symmetric, timed correctly, and free of stale state bugs? | `docs/codex_review_playbook.md`, `docs/mechanics_changes_from_base.md` |
| Memory and bank pressure | Are scarce banks protected before adding optional code or data? | `docs/generated/dev_index.md`, `docs/codex_context.md` |
...
| Regression traps | Can a small audit catch the kind of bug that would quietly come back later? | `tools/audit/`, `docs/codex_review_playbook.md` |
| Progression and pacing | Where does the hack first become exciting, unfair, too easy, or tedious? | `docs/codex_context.md`, `docs/project_map.md` |
| World texture | Does a change preserve old-game Johto texture while making the world feel alive? | `docs/codex_context.md`, `docs/mechanics_changes_from_base.md` |
...
- `outbox/`: exploratory journals, running notes, handoff prompts, and rough
  observations a future session should mine but not treat as authority.
...
Do not bury source-truth claims in a chat transcript or a vibes-only journal.
If a finding changes what future sessions should do, route it into docs,
roadmap, audit evidence, or a self-contained outbox handoff before stopping.
