...
| `docs/project_context.md` | Project intent, First-Playthrough Promise, design rules, done criteria. | Current file locations beyond first-read routing. |
...
| "I made a reversible judgment call that future helpers may question." | A dated note under `decisions/`. |
...
| "A session is ending and needs a durable handoff." | `.claude_handoffs/YYYY-MM-DD-HHMM-<slug>.md` plus roadmap updates. |
