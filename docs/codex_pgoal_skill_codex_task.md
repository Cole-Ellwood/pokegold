...
- `C:/Users/lolno/.claude/projects/C--Users-lolno-Downloads-pokemon-gold-hack/memory/feedback_poll_codex_progress.md` — 15s talking/thinking, 150s observably-coding screenshot cadence (current canonical, supersedes earlier rules).
