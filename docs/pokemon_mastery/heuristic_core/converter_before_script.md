# Heuristic: Converter Before Script

Status: live tiny card.

Use when: sleep, Toxic, Spikes, Rapid Spin, Recover, Rest, or a safe switch is
tempting because it is normally good.

Rule: rank route-changing actions before default scripts.
...
Archive: `policy_cards/active_pressure_before_status.md`;
