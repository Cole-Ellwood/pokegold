...
| `MISDREAVUS` | provisional | midgame | Bulky mono-Ghost disruptor for Morty and player teams, trading the older high-Attack spread for real mixed bulk and status pressure. | Raw stats `100/80/90/85/70/95`; Ghost typing; Confuse Ray, Toxic, Thunder, Shadow Ball; Morty uses Leftovers at level 25. | Preserve bulky status identity; do not drift into a fast Gengar clone or a pure physical attacker. | Playtest Morty's revised pressure and player Misdreavus value after the Attack-to-bulk shift. |
