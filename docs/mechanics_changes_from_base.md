...
- Added probabilistic best-vs-public-switch-hedge move pick to avoid predictable
  pivot punishment while still committing to the best move when no public hedge exists.
