...
moves, selected PoisonPowder/Poison Gas/Toxic poison-status moves, repeated
...
application outside selected poison-status moves, sleep/freeze/paralysis, burn
application, Safeguard/Substitute, held status-healing item consumption, Rest,
weather/time healing, drain moves, Heal Bell, RNG-consuming mechanics outside
the listed branch points, live Boss AI scoring, or scripts until the simulator
