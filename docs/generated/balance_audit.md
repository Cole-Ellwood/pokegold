...
| 6 | `SUDOWOODO` | `current-final`, `watch-bst-final`, `weak-reliable-stab`, `low-and-unbuffed-vs-baseline`, `large-bst-regression-vs-baseline` | 455 | 550 | -95 | 90/105/125/45/30/60 | HP-40, Atk-45, Def-20, Spe+15, SpD-5 | ROCK/ROCK | - | - | 9 | 28 | ROCK_SLIDE (ROCK 75bp 90%) | FOCUS_PUNCH (FIGHTING 150bp 100%) |
...
| 0 | `UNOWN` | `current-final`, `documented-gimmick` | 420 | 496 | -76 | 70/70/70/70/70/70 | HP-78, Atk-32, Def+22, Spe+22, SpA-32, SpD+22 | PSYCHIC_TYPE/PSYCHIC_TYPE | - | - | 1 | 0 | - | - |
...
| 3 | `LEDIAN` | `current-final`, `watch-bst-final`, `low-and-unbuffed-vs-baseline` | 470 | 530 | -60 | 80/100/50/90/45/105 | HP+10, Spe-55, SpA-10, SpD-5 | BUG/FLYING | - | - | 12 | 28 | WING_ATTACK (FLYING 80bp 100%) | SOLARBEAM (GRASS 180bp 100%) |
...
| 3 | `UMBREON` | `current-final`, `weak-reliable-stab`, `large-bst-regression-vs-baseline` | 530 | 615 | -85 | 100/65/110/65/60/130 | HP-15, Def-30, SpD-40 | DARK/DARK | - | - | 10 | 24 | FAINT_ATTACK (DARK 60bp 100%) | HYPER_BEAM (NORMAL 180bp 90%) |
...
| 2 | `MEGANIUM` | `current-final`, `large-bst-regression-vs-baseline` | 555 | 645 | -90 | 130/75/107/60/83/100 | HP+15, Atk-13, Def-28, Spe-22, SpA-7, SpD-35 | GRASS/GRASS | - | - | 12 | 26 | SOLARBEAM (GRASS 180bp 100%) | SOLARBEAM (GRASS 180bp 100%) |
...
| 2 | `DRAGONITE` | `current-final`, `large-bst-regression-vs-baseline` | 630 | 740 | -110 | 121/134/95/70/110/100 | HP-40, Atk-20, Def-30, Spe+50, SpA-30, SpD-40 | DRAGON/FLYING | - | - | 15 | 39 | OUTRAGE (DRAGON 100bp 100%) | HYPER_BEAM (NORMAL 180bp 90%) |
...
| 1 | `BEEDRILL` | `current-final`, `watch-bst-final` | 450 | 385 | 65 | 75/90/40/120/45/80 | HP+10, Atk+10, Spe+45 | BUG/POISON | - | - | 7 | 21 | SLUDGE_BOMB (POISON 90bp 100%) | HYPER_BEAM (NORMAL 180bp 90%) |
| 1 | `BUTTERFREE` | `current-final`, `watch-bst-final` | 450 | 385 | 65 | 90/45/40/85/80/110 | HP+30, Def-10, Spe+15, SpD+30 | BUG/FLYING | - | - | 9 | 21 | WING_ATTACK (FLYING 80bp 100%) | SOLARBEAM (GRASS 180bp 100%) |
...
| 0 | `HITMONLEE` | `current-final` | 500 | 535 | -35 | 80/120/53/102/35/110 | HP+30, Atk-30, Spe-35 | FIGHTING/FIGHTING | - | - | 11 | 20 | FOCUS_PUNCH (FIGHTING 150bp 100%) | FOCUS_PUNCH (FIGHTING 150bp 100%) |
...
| 0 | `NOCTOWL` | `current-final` | 500 | 517 | -17 | 100/50/50/70/110/120 | HP+20, Spe-55, SpA-6, SpD+24 | NORMAL/FLYING | - | - | 12 | 21 | HYPER_BEAM (NORMAL 180bp 90%) | HYPER_BEAM (NORMAL 180bp 90%) |
...
| 0 | `PINSIR` | `current-final` | 520 | 500 | 20 | 80/140/100/75/55/70 | HP+15, Atk+15, Spe-10 | BUG/BUG | - | - | 8 | 22 | LEECH_LIFE (BUG 80bp 100%) | HYPER_BEAM (NORMAL 180bp 90%) |
| 0 | `SCIZOR` | `current-final` | 520 | 500 | 20 | 80/130/120/65/45/80 | HP+10, Def+20, SpA-10 | BUG/STEEL | - | - | 10 | 24 | LEECH_LIFE (BUG 80bp 100%) | HYPER_BEAM (NORMAL 180bp 90%) |
...
| 0 | `MUK` | `current-final` | 540 | 560 | -20 | 120/85/120/50/65/100 | HP-15, Atk-50, Def+45 | POISON/POISON | - | - | 10 | 25 | SLUDGE_BOMB (POISON 90bp 100%) | HYPER_BEAM (NORMAL 180bp 90%) |
...
| 0 | `VAPOREON` | `current-final` | 540 | 525 | 15 | 130/65/60/65/110/110 | SpD+15 | WATER/WATER | - | - | 10 | 26 | HYDRO_PUMP (WATER 120bp 80%) | HYPER_BEAM (NORMAL 180bp 90%) |
...
| 0 | `ALAKAZAM` | `current-final` | 555 | 490 | 65 | 60/50/45/120/150/130 | HP+5, SpA+15, SpD+45 | PSYCHIC_TYPE/PSYCHIC_TYPE | - | - | 9 | 27 | FUTURE_SIGHT (PSYCHIC_TYPE 120bp 90%) | HYPER_BEAM (NORMAL 180bp 90%) |
| 0 | `CLOYSTER` | `current-final` | 555 | 525 | 30 | 80/95/180/70/85/45 | HP+30 | WATER/ICE | - | - | 7 | 19 | BLIZZARD (ICE 120bp 85%) | HYPER_BEAM (NORMAL 180bp 90%) |
...
| 0 | `FERALIGATR` | `current-final` | 555 | 613 | -58 | 85/105/100/87/95/83 | HP-3, Atk-22, Def-3, Spe+5, SpA-30, SpD-5 | WATER/FIGHTING | - | - | 11 | 32 | FOCUS_PUNCH (FIGHTING 150bp 100%) | HYPER_BEAM (NORMAL 180bp 90%) |
...
| 0 | `TYPHLOSION` | `current-final` | 555 | 608 | -53 | 78/85/78/114/130/70 | Atk-7, Def-2, Spe-9, SpA-15, SpD-20 | FIRE/FIRE | - | - | 11 | 31 | FIRE_BLAST (FIRE 140bp 85%) | HYPER_BEAM (NORMAL 180bp 90%) |
...
| 0 | `ENTEI` | `current-final` | 600 | 580 | 20 | 115/135/85/100/90/75 | Atk+20 | FIRE/FIRE | - | - | 9 | 27 | FIRE_BLAST (FIRE 140bp 85%) | SOLARBEAM (GRASS 180bp 100%) |
...
| 0 | `RAIKOU` | `current-final` | 600 | 580 | 20 | 90/85/75/115/135/100 | SpA+20 | ELECTRIC/ELECTRIC | - | - | 9 | 27 | THUNDER (ELECTRIC 120bp 70%) | HYPER_BEAM (NORMAL 180bp 90%) |
| 0 | `SUICUNE` | `current-final` | 600 | 580 | 20 | 120/75/115/85/90/115 | HP+20 | WATER/WATER | - | - | 9 | 28 | HYDRO_PUMP (WATER 120bp 80%) | HYPER_BEAM (NORMAL 180bp 90%) |
...
| 0 | `CROBAT` | `current-final` | 605 | 605 | 0 | 100/120/105/130/70/80 | HP-45, Atk+60, Def+25, Spe-40 | POISON/FLYING | - | - | 10 | 20 | SLUDGE_BOMB (POISON 90bp 100%) | HYPER_BEAM (NORMAL 180bp 90%) |
| 0 | `ARTICUNO` | `current-final` | 610 | 580 | 30 | 100/95/100/85/105/125 | HP+10, Atk+10, SpA+10 | ICE/FLYING | - | - | 9 | 24 | BLIZZARD (ICE 120bp 85%) | HYPER_BEAM (NORMAL 180bp 90%) |
...
| 0 | `ARCANINE` | `current-final` | 615 | 555 | 60 | 120/115/80/90/130/80 | HP+30, Atk+5, Spe-5, SpA+30 | FIRE/FIRE | - | - | 11 | 22 | FIRE_BLAST (FIRE 140bp 85%) | HYPER_BEAM (NORMAL 180bp 90%) |
...
| 0 | `MEWTWO` | `current-final` | 680 | 680 | 0 | 106/110/90/130/154/90 | +0 | PSYCHIC_TYPE/PSYCHIC_TYPE | - | - | 11 | 34 | FUTURE_SIGHT (PSYCHIC_TYPE 120bp 90%) | SOLARBEAM (GRASS 180bp 100%) |
...
| 0 | `LUGIA` | `current-final` | 740 | 680 | 60 | 116/100/140/120/100/164 | HP+10, Atk+10, Def+10, Spe+10, SpA+10, SpD+10 | PSYCHIC_TYPE/FLYING | - | - | 10 | 37 | FUTURE_SIGHT (PSYCHIC_TYPE 120bp 90%) | HYPER_BEAM (NORMAL 180bp 90%) |
