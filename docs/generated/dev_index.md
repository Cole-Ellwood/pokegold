...
- Anchors: `BossAI_IncrementTurnsElapsed` (0e:4198, `engine/battle/ai/boss_platform.asm:24`); `BossAI_RecordPlayerSwitch` (0e:4243, `engine/battle/ai/boss_platform.asm:162`); `BossAI_SelectMove` (0e:54c0, `engine/battle/ai/boss_policy_move.asm:2815`); `BossAI_TrySwitch` (0e:5693, `engine/battle/ai/boss_policy_switch.asm:17`); `BossAI_ComputeSwitchConfidence` (0e:63f6, `engine/battle/ai/boss_policy_switch.asm:1034`); `BossAI_PredictPlayerSwitch` (0e:646c, `engine/battle/ai/boss_policy_move.asm:4130`); `BossAI_RecordRevealedPlayerMove` (0e:4396, `engine/battle/ai/boss_platform.asm:312`); `BossAI_CurrentEnemyMoveHasKOPressure` (0e:5e70, `engine/battle/ai/boss_policy_move.asm:3319`); `BossAI_CurrentEnemyMovePressureScore` (0e:5e81, `engine/battle/ai/boss_policy_move.asm:3331`); `BossAI_PlayerHasPublicThreatVsEnemy` (0e:5cda, `engine/battle/ai/boss_policy_move.asm:3179`); `BossAI_PublicEnemyFaster` (0e:6243, `engine/battle/ai/boss_policy_move.asm:4035`); `BossAI_CheckAbleToSwitchSafe` (0e:5963, `engine/battle/ai/boss_policy_switch.asm:559`); `BossAI_RefineSwitchCandidateForPlausibleRisk` (0e:7383, `engine/battle/ai/boss_policy_switch.asm:1115`); `BossAI_ApplyPlausibleRiskToSwitchConfidence` (0e:75b2, `engine/battle/ai/boss_policy_switch.asm:1496`)
...
| `Enemy Trainers` | ROMX | 0e:4000-7f5b | 16220 | ROMX 0e | `engine/battle/ai/boss_platform.asm`, `engine/battle/ai/boss_policy_move.asm`, `engine/battle/ai/boss_policy_switch.asm`, `engine/battle/ai/boss_thunks.asm`, +6 more |
...
| `BossAI_RecordPlayerSwitch` | 0e:4243 | `engine/battle/ai/boss_platform.asm:162` |
| `BossAI_SelectMove` | 0e:54c0 | `engine/battle/ai/boss_policy_move.asm:2815` |
| `BossAI_TrySwitch` | 0e:5693 | `engine/battle/ai/boss_policy_switch.asm:17` |
| `BossAI_ComputeSwitchConfidence` | 0e:63f6 | `engine/battle/ai/boss_policy_switch.asm:1034` |
| `BossAI_PredictPlayerSwitch` | 0e:646c | `engine/battle/ai/boss_policy_move.asm:4130` |
| `BossAI_RecordRevealedPlayerMove` | 0e:4396 | `engine/battle/ai/boss_platform.asm:312` |
| `BossAI_CurrentEnemyMoveHasKOPressure` | 0e:5e70 | `engine/battle/ai/boss_policy_move.asm:3319` |
| `BossAI_CurrentEnemyMovePressureScore` | 0e:5e81 | `engine/battle/ai/boss_policy_move.asm:3331` |
| `BossAI_PlayerHasPublicThreatVsEnemy` | 0e:5cda | `engine/battle/ai/boss_policy_move.asm:3179` |
| `BossAI_PublicEnemyFaster` | 0e:6243 | `engine/battle/ai/boss_policy_move.asm:4035` |
| `BossAI_CheckAbleToSwitchSafe` | 0e:5963 | `engine/battle/ai/boss_policy_switch.asm:559` |
| `BossAI_RefineSwitchCandidateForPlausibleRisk` | 0e:7383 | `engine/battle/ai/boss_policy_switch.asm:1115` |
| `BossAI_ApplyPlausibleRiskToSwitchConfidence` | 0e:75b2 | `engine/battle/ai/boss_policy_switch.asm:1496` |
| `BossAITierMap` | 0e:7e96 | `data/trainers/ai_tiers.asm:1` |
...
| `AIDamageCalc` | 11:74c7 | `engine/battle/ai/scoring.asm:2985` |
