...
- Anchors: `BossAI_IncrementTurnsElapsed` (0e:454d, `engine/battle/ai/boss_platform.asm:24`); `BossAI_RecordPlayerSwitch` (0e:45db, `engine/battle/ai/boss_platform.asm:126`); `BossAI_SelectMove` (0e:584c, `engine/battle/ai/boss_policy_move.asm:2770`); `BossAI_SwitchOrTryItem` (0e:593e, `engine/battle/ai/boss_policy_switch.asm:17`); `BossAI_ComputeSwitchConfidence` (0e:65d9, `engine/battle/ai/boss_policy_switch.asm:751`); `BossAI_PredictPlayerSwitch` (0e:665c, `engine/battle/ai/boss_policy_move.asm:3709`); `BossAI_RecordRevealedPlayerMove` (0e:4717, `engine/battle/ai/boss_platform.asm:260`); `BossAI_CurrentEnemyMoveHasKOPressure` (0e:60aa, `engine/battle/ai/boss_policy_move.asm:3136`); `BossAI_CurrentEnemyMovePressureScore` (0e:60d2, `engine/battle/ai/boss_policy_move.asm:3170`); `BossAI_PlayerHasPublicThreatVsEnemy` (0e:5f13, `engine/battle/ai/boss_policy_move.asm:2978`); `BossAI_PublicEnemyFaster` (0e:6382, `engine/battle/ai/boss_policy_move.asm:3634`); `BossAI_CheckAbleToSwitchSafe` (0e:5adb, `engine/battle/ai/boss_policy_switch.asm:298`); `BossAI_RefineSwitchCandidateForPlausibleRisk` (0e:7526, `engine/battle/ai/boss_policy_switch.asm:833`); `BossAI_ApplyPlausibleRiskToSwitchConfidence` (0e:775a, `engine/battle/ai/boss_policy_switch.asm:1216`)
...
- Anchors: `TypePassive_ApplyDamageModifiers_Far` (11:6a44, `engine/battle/type_passive_damage_mods.asm:44`); `TypePassive_TryDarkStatusShield_Far` (11:6fc9, `engine/battle/type_passive_damage_mods.asm:1069`); `TypePassive_MaybePoisonRetaliation_Far` (11:7026, `engine/battle/type_passive_damage_mods.asm:1135`); `ApplyLateGenDamageMultipliers_Far` (11:65d2, `engine/battle/late_gen_held_items.asm:183`); `HandleLateGenAfterHitEffects_Far` (11:668b, `engine/battle/late_gen_held_items.asm:301`); `TryActivateDittoImposter` (01:799b, `engine/battle/ditto_imposter.asm:1`)
...
- Anchors: `Moves` (10:5aaa, `data/moves/moves.asm:14`); `MoveEffects` (09:7489, `data/moves/effects.asm:3`); `MoveContactFlags` (11:71b4, `data/moves/contact_flags.asm:4`); `Spikes` (09:79a5, `data/moves/effects.asm:1525`); `RapidSpin` (09:7a7a, `data/moves/effects.asm:1772`)
...
| `Enemy Trainers` | ROMX | 0e:4000-7ecc | 16077 | ROMX 0e | `engine/battle/ai/boss_platform.asm`, `engine/battle/ai/boss_policy_move.asm`, `engine/battle/ai/boss_policy_switch.asm`, `engine/battle/ai/boss_thunks.asm`, +6 more |
...
| `Late Gen Held Items` | ROMX | 11:64fd-72b1 | 3509 |  | `engine/battle/late_gen_held_items.asm`, `engine/battle/type_passive_damage_mods.asm`, `main.asm` |
...
| `BossAI_SelectMove` | 0e:584c | `engine/battle/ai/boss_policy_move.asm:2770` |
| `BossAI_SwitchOrTryItem` | 0e:593e | `engine/battle/ai/boss_policy_switch.asm:17` |
| `BossAI_ComputeSwitchConfidence` | 0e:65d9 | `engine/battle/ai/boss_policy_switch.asm:751` |
| `BossAI_PredictPlayerSwitch` | 0e:665c | `engine/battle/ai/boss_policy_move.asm:3709` |
| `BossAI_RecordRevealedPlayerMove` | 0e:4717 | `engine/battle/ai/boss_platform.asm:260` |
| `BossAI_CurrentEnemyMoveHasKOPressure` | 0e:60aa | `engine/battle/ai/boss_policy_move.asm:3136` |
| `BossAI_CurrentEnemyMovePressureScore` | 0e:60d2 | `engine/battle/ai/boss_policy_move.asm:3170` |
| `BossAI_PlayerHasPublicThreatVsEnemy` | 0e:5f13 | `engine/battle/ai/boss_policy_move.asm:2978` |
| `BossAI_PublicEnemyFaster` | 0e:6382 | `engine/battle/ai/boss_policy_move.asm:3634` |
| `BossAI_CheckAbleToSwitchSafe` | 0e:5adb | `engine/battle/ai/boss_policy_switch.asm:298` |
| `BossAI_RefineSwitchCandidateForPlausibleRisk` | 0e:7526 | `engine/battle/ai/boss_policy_switch.asm:833` |
| `BossAI_ApplyPlausibleRiskToSwitchConfidence` | 0e:775a | `engine/battle/ai/boss_policy_switch.asm:1216` |
| `BossAITierMap` | 0e:7e07 | `data/trainers/ai_tiers.asm:1` |
...
| `TypePassive_ApplyDamageModifiers_Far` | 11:6a44 | `engine/battle/type_passive_damage_mods.asm:44` |
| `TypePassive_TryDarkStatusShield_Far` | 11:6fc9 | `engine/battle/type_passive_damage_mods.asm:1069` |
| `TypePassive_MaybePoisonRetaliation_Far` | 11:7026 | `engine/battle/type_passive_damage_mods.asm:1135` |
| `ApplyLateGenDamageMultipliers_Far` | 11:65d2 | `engine/battle/late_gen_held_items.asm:183` |
| `HandleLateGenAfterHitEffects_Far` | 11:668b | `engine/battle/late_gen_held_items.asm:301` |
| `TryActivateDittoImposter` | 01:799b | `engine/battle/ditto_imposter.asm:1` |
| `Moves` | 10:5aaa | `data/moves/moves.asm:14` |
| `MoveEffects` | 09:7489 | `data/moves/effects.asm:3` |
| `MoveContactFlags` | 11:71b4 | `data/moves/contact_flags.asm:4` |
...
| `IsChoiceHeldEffect_Far` | 11:6983 | `engine/battle/late_gen_held_items.asm:819` |
| `IsMoveBlockedByAssaultVest_Far` | 11:6990 | `engine/battle/late_gen_held_items.asm:831` |
