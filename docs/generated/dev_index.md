...
- Anchors: `TypePassive_ApplyDamageModifiers_Far` (11:6b7b, `engine/battle/type_passive_damage_mods.asm:44`); `TypePassive_TryDarkStatusShield_Far` (11:7100, `engine/battle/type_passive_damage_mods.asm:1069`); `TypePassive_MaybePoisonRetaliation_Far` (11:7161, `engine/battle/type_passive_damage_mods.asm:1142`); `ApplyLateGenDamageMultipliers_Far` (11:6709, `engine/battle/late_gen_held_items.asm:183`); `HandleLateGenAfterHitEffects_Far` (11:67c2, `engine/battle/late_gen_held_items.asm:301`); `TryActivateDittoImposter` (01:79a4, `engine/battle/ditto_imposter.asm:1`)
...
- Anchors: `Moves` (10:5aaa, `data/moves/moves.asm:14`); `MoveEffects` (09:7489, `data/moves/effects.asm:3`); `MoveContactFlags` (11:72f1, `data/moves/contact_flags.asm:4`); `Spikes` (09:79a7, `data/moves/effects.asm:1529`); `RapidSpin` (09:7a7c, `data/moves/effects.asm:1776`)
...
| `Late Gen Held Items` | ROMX | 11:6634-73ee | 3515 |  | `engine/battle/late_gen_held_items.asm`, `engine/battle/type_passive_damage_mods.asm`, `main.asm` |
...
| `TypePassive_ApplyDamageModifiers_Far` | 11:6b7b | `engine/battle/type_passive_damage_mods.asm:44` |
| `TypePassive_TryDarkStatusShield_Far` | 11:7100 | `engine/battle/type_passive_damage_mods.asm:1069` |
| `TypePassive_MaybePoisonRetaliation_Far` | 11:7161 | `engine/battle/type_passive_damage_mods.asm:1142` |
| `ApplyLateGenDamageMultipliers_Far` | 11:6709 | `engine/battle/late_gen_held_items.asm:183` |
| `HandleLateGenAfterHitEffects_Far` | 11:67c2 | `engine/battle/late_gen_held_items.asm:301` |
| `TryActivateDittoImposter` | 01:79a4 | `engine/battle/ditto_imposter.asm:1` |
| `Moves` | 10:5aaa | `data/moves/moves.asm:14` |
| `MoveEffects` | 09:7489 | `data/moves/effects.asm:3` |
| `MoveContactFlags` | 11:72f1 | `data/moves/contact_flags.asm:4` |
...
| `IsChoiceHeldEffect_Far` | 11:6aba | `engine/battle/late_gen_held_items.asm:819` |
| `IsMoveBlockedByAssaultVest_Far` | 11:6ac7 | `engine/battle/late_gen_held_items.asm:831` |
