...
- Anchors: `TypePassive_ApplyDamageModifiers_Far` (0e:7629, `engine/battle/type_passive_damage_mods.asm:44`); `TypePassive_TryDarkStatusShield_Far` (0e:7baf, `engine/battle/type_passive_damage_mods.asm:1066`); `TypePassive_MaybePoisonRetaliation_Far` (0e:7bfe, `engine/battle/type_passive_damage_mods.asm:1127`); `ApplyLateGenDamageMultipliers_Far` (0e:71bf, `engine/battle/late_gen_held_items.asm:166`); `HandleLateGenAfterHitEffects_Far` (0e:7278, `engine/battle/late_gen_held_items.asm:284`); `TryActivateDittoImposter` (01:7a10, `engine/battle/ditto_imposter.asm:1`)
...
- Anchors: `Moves` (10:5af6, `data/moves/moves.asm:14`); `MoveEffects` (09:750c, `data/moves/effects.asm:3`); `MoveContactFlags` (0e:7d6d, `data/moves/contact_flags.asm:4`); `Spikes` (09:7a28, `data/moves/effects.asm:1525`); `RapidSpin` (09:7afd, `data/moves/effects.asm:1772`)
...
| `Late Gen Held Items` | ROMX | 0e:70f2-7e6a | 3449 |  | `engine/battle/late_gen_held_items.asm`, `engine/battle/type_passive_damage_mods.asm`, `main.asm` |
...
| `BossAI_ComputeSwitchConfidence` | 0e:5c81 | `engine/battle/ai/boss.asm:3960` |
| `BossAI_PredictPlayerSwitch` | 0e:5d01 | `engine/battle/ai/boss.asm:4033` |
...
| `BossAI_PublicEnemyFaster` | 0e:5a2a | `engine/battle/ai/boss.asm:3543` |
...
| `TypePassive_ApplyDamageModifiers_Far` | 0e:7629 | `engine/battle/type_passive_damage_mods.asm:44` |
| `TypePassive_TryDarkStatusShield_Far` | 0e:7baf | `engine/battle/type_passive_damage_mods.asm:1066` |
| `TypePassive_MaybePoisonRetaliation_Far` | 0e:7bfe | `engine/battle/type_passive_damage_mods.asm:1127` |
| `ApplyLateGenDamageMultipliers_Far` | 0e:71bf | `engine/battle/late_gen_held_items.asm:166` |
| `HandleLateGenAfterHitEffects_Far` | 0e:7278 | `engine/battle/late_gen_held_items.asm:284` |
...
| `MoveContactFlags` | 0e:7d6d | `data/moves/contact_flags.asm:4` |
...
| `IsChoiceHeldEffect_Far` | 0e:7570 | `engine/battle/late_gen_held_items.asm:802` |
| `IsMoveBlockedByAssaultVest_Far` | 0e:7579 | `engine/battle/late_gen_held_items.asm:810` |
