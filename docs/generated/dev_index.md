...
- Anchors: `BossAI_IncrementTurnsElapsed` (0e:4198, `engine/battle/ai/boss_platform.asm:24`); `BossAI_RecordPlayerSwitch` (0e:4226, `engine/battle/ai/boss_platform.asm:126`); `BossAI_SelectMove` (0e:542b, `engine/battle/ai/boss_policy_move.asm:2786`); `BossAI_TrySwitch` (0e:551d, `engine/battle/ai/boss_policy_switch.asm:17`); `BossAI_ComputeSwitchConfidence` (0e:61b1, `engine/battle/ai/boss_policy_switch.asm:898`); `BossAI_PredictPlayerSwitch` (0e:6227, `engine/battle/ai/boss_policy_move.asm:3810`); `BossAI_RecordRevealedPlayerMove` (0e:4362, `engine/battle/ai/boss_platform.asm:260`); `BossAI_CurrentEnemyMoveHasKOPressure` (0e:5c93, `engine/battle/ai/boss_policy_move.asm:3152`); `BossAI_CurrentEnemyMovePressureScore` (0e:5cbb, `engine/battle/ai/boss_policy_move.asm:3186`); `BossAI_PlayerHasPublicThreatVsEnemy` (0e:5add, `engine/battle/ai/boss_policy_move.asm:2994`); `BossAI_PublicEnemyFaster` (0e:5fa8, `engine/battle/ai/boss_policy_move.asm:3715`); `BossAI_CheckAbleToSwitchSafe` (0e:57da, `engine/battle/ai/boss_policy_switch.asm:524`); `BossAI_RefineSwitchCandidateForPlausibleRisk` (0e:7150, `engine/battle/ai/boss_policy_switch.asm:979`); `BossAI_ApplyPlausibleRiskToSwitchConfidence` (0e:7384, `engine/battle/ai/boss_policy_switch.asm:1362`)
...
| `Enemy Trainers` | ROMX | 0e:4000-7d10 | 15633 | ROMX 0e | `engine/battle/ai/boss_platform.asm`, `engine/battle/ai/boss_policy_move.asm`, `engine/battle/ai/boss_policy_switch.asm`, `engine/battle/ai/boss_thunks.asm`, +6 more |
...
| `BossAI_ComputeSwitchConfidence` | 0e:61b1 | `engine/battle/ai/boss_policy_switch.asm:898` |
| `BossAI_PredictPlayerSwitch` | 0e:6227 | `engine/battle/ai/boss_policy_move.asm:3810` |
...
| `BossAI_PublicEnemyFaster` | 0e:5fa8 | `engine/battle/ai/boss_policy_move.asm:3715` |
| `BossAI_CheckAbleToSwitchSafe` | 0e:57da | `engine/battle/ai/boss_policy_switch.asm:524` |
| `BossAI_RefineSwitchCandidateForPlausibleRisk` | 0e:7150 | `engine/battle/ai/boss_policy_switch.asm:979` |
| `BossAI_ApplyPlausibleRiskToSwitchConfidence` | 0e:7384 | `engine/battle/ai/boss_policy_switch.asm:1362` |
| `BossAITierMap` | 0e:7c4b | `data/trainers/ai_tiers.asm:1` |
