...
- Anchors: `BossAI_IncrementTurnsElapsed` (0e:4198, `engine/battle/ai/boss_platform.asm:24`); `BossAI_RecordPlayerSwitch` (0e:4237, `engine/battle/ai/boss_platform.asm:145`); `BossAI_SelectMove` (0e:5496, `engine/battle/ai/boss_policy_move.asm:2815`); `BossAI_TrySwitch` (0e:5669, `engine/battle/ai/boss_policy_switch.asm:17`); `BossAI_ComputeSwitchConfidence` (0e:63ac, `engine/battle/ai/boss_policy_switch.asm:1003`); `BossAI_PredictPlayerSwitch` (0e:6422, `engine/battle/ai/boss_policy_move.asm:4129`); `BossAI_RecordRevealedPlayerMove` (0e:4373, `engine/battle/ai/boss_platform.asm:279`); `BossAI_CurrentEnemyMoveHasKOPressure` (0e:5e32, `engine/battle/ai/boss_policy_move.asm:3319`); `BossAI_CurrentEnemyMovePressureScore` (0e:5e43, `engine/battle/ai/boss_policy_move.asm:3331`); `BossAI_PlayerHasPublicThreatVsEnemy` (0e:5c9c, `engine/battle/ai/boss_policy_move.asm:3179`); `BossAI_PublicEnemyFaster` (0e:6203, `engine/battle/ai/boss_policy_move.asm:4034`); `BossAI_CheckAbleToSwitchSafe` (0e:5925, `engine/battle/ai/boss_policy_switch.asm:541`); `BossAI_RefineSwitchCandidateForPlausibleRisk` (0e:7343, `engine/battle/ai/boss_policy_switch.asm:1084`); `BossAI_ApplyPlausibleRiskToSwitchConfidence` (0e:7572, `engine/battle/ai/boss_policy_switch.asm:1465`)
...
| `Enemy Trainers` | ROMX | 0e:4000-7f0f | 16144 | ROMX 0e | `engine/battle/ai/boss_platform.asm`, `engine/battle/ai/boss_policy_move.asm`, `engine/battle/ai/boss_policy_switch.asm`, `engine/battle/ai/boss_thunks.asm`, +6 more |
...
| `BossAI_RecordPlayerSwitch` | 0e:4237 | `engine/battle/ai/boss_platform.asm:145` |
| `BossAI_SelectMove` | 0e:5496 | `engine/battle/ai/boss_policy_move.asm:2815` |
| `BossAI_TrySwitch` | 0e:5669 | `engine/battle/ai/boss_policy_switch.asm:17` |
| `BossAI_ComputeSwitchConfidence` | 0e:63ac | `engine/battle/ai/boss_policy_switch.asm:1003` |
| `BossAI_PredictPlayerSwitch` | 0e:6422 | `engine/battle/ai/boss_policy_move.asm:4129` |
| `BossAI_RecordRevealedPlayerMove` | 0e:4373 | `engine/battle/ai/boss_platform.asm:279` |
| `BossAI_CurrentEnemyMoveHasKOPressure` | 0e:5e32 | `engine/battle/ai/boss_policy_move.asm:3319` |
| `BossAI_CurrentEnemyMovePressureScore` | 0e:5e43 | `engine/battle/ai/boss_policy_move.asm:3331` |
| `BossAI_PlayerHasPublicThreatVsEnemy` | 0e:5c9c | `engine/battle/ai/boss_policy_move.asm:3179` |
| `BossAI_PublicEnemyFaster` | 0e:6203 | `engine/battle/ai/boss_policy_move.asm:4034` |
| `BossAI_CheckAbleToSwitchSafe` | 0e:5925 | `engine/battle/ai/boss_policy_switch.asm:541` |
| `BossAI_RefineSwitchCandidateForPlausibleRisk` | 0e:7343 | `engine/battle/ai/boss_policy_switch.asm:1084` |
| `BossAI_ApplyPlausibleRiskToSwitchConfidence` | 0e:7572 | `engine/battle/ai/boss_policy_switch.asm:1465` |
| `BossAITierMap` | 0e:7e4a | `data/trainers/ai_tiers.asm:1` |
