...
- Anchors: `BossAI_IncrementTurnsElapsed` (0e:5561, `engine/battle/ai/boss.asm:1`); `BossAI_RecordPlayerSwitch` (0e:558a, `engine/battle/ai/boss.asm:26`); `BossAI_SelectMove` (0e:62e5, `engine/battle/ai/boss.asm:2204`); `BossAI_SwitchOrTryItem` (0e:63d0, `engine/battle/ai/boss.asm:2391`); `BossAI_ComputeSwitchConfidence` (0e:6b02, `engine/battle/ai/boss.asm:3709`); `BossAI_PredictPlayerSwitch` (0e:6b82, `engine/battle/ai/boss.asm:3782`); `BossAI_RecordRevealedPlayerMove` (0e:56c6, `engine/battle/ai/boss.asm:290`); `BossAI_CurrentEnemyMoveHasKOPressure` (0e:665e, `engine/battle/ai/boss.asm:2840`); `BossAI_CurrentEnemyMovePressureScore` (0e:6686, `engine/battle/ai/boss.asm:2873`); `BossAI_PlayerHasPublicThreatVsEnemy` (0e:64c5, `engine/battle/ai/boss.asm:2555`); `BossAI_PublicEnemyFaster` (0e:68b0, `engine/battle/ai/boss.asm:3296`); `BossAI_CheckAbleToSwitchSafe` (0e:647b, `engine/battle/ai/boss.asm:2499`); `BossAI_RefineSwitchCandidateForPlausibleRisk` (0e:7736, `engine/battle/ai/boss.asm:5936`); `BossAI_ApplyPlausibleRiskToSwitchConfidence` (0e:796a, `engine/battle/ai/boss.asm:6308`)
...
- Anchors: `TypePassive_ApplyDamageModifiers_Far` (0b:73d2, `engine/battle/type_passive_damage_mods.asm:44`); `TypePassive_TryDarkStatusShield_Far` (0b:795f, `engine/battle/type_passive_damage_mods.asm:1057`); `TypePassive_MaybePoisonRetaliation_Far` (0b:79ae, `engine/battle/type_passive_damage_mods.asm:1118`); `ApplyLateGenDamageMultipliers_Far` (0b:6f77, `engine/battle/late_gen_held_items.asm:168`); `HandleLateGenAfterHitEffects_Far` (0b:7032, `engine/battle/late_gen_held_items.asm:289`); `TryActivateDittoImposter` (01:79b8, `engine/battle/ditto_imposter.asm:1`)
...
- Anchors: `Moves` (10:5af6, `data/moves/moves.asm:14`); `MoveEffects` (09:7510, `data/moves/effects.asm:3`); `MoveContactFlags` (0b:7b21, `data/moves/contact_flags.asm:4`); `Spikes` (09:7a2c, `data/moves/effects.asm:1525`); `RapidSpin` (09:7b01, `data/moves/effects.asm:1772`)
...
- Anchors: `Special` (03:422b, `engine/events/specials.asm:1`); `SpecialsPointers` (03:4239, `data/events/special_pointers.asm:14`); `MoveReminder` (0b:4451, `engine/events/move_reminder.asm:8`); `TMTutorTeachAnyTM` (0b:4bf5, `engine/events/tm_tutor.asm:1`)
...
| --- | --- | --- | ---: | --- | --- |
| `Home` | ROM0 | 00:0150-3fda | 16011 | ROM0 00 | `home.asm`, `home/array.asm`, `home/audio.asm`, `home/battle.asm`, +49 more |
| `bankB` | ROMX | 0b:4000-4d6c | 3437 | ROMX 0b | `engine/battle/ai/redundant.asm`, `engine/battle/trainer_huds.asm`, `engine/events/move_deleter.asm`, `engine/events/move_reminder.asm`, +7 more |
| `Late Gen Held Items` | ROMX | 0b:6e7c-7c1e | 3491 |  | `engine/battle/late_gen_held_items.asm`, `engine/battle/type_passive_damage_mods.asm`, `main.asm` |
...
| `Enemy Trainers` | ROMX | 0e:4000-7dd1 | 15826 | ROMX 0e | `engine/battle/ai/boss.asm`, `engine/battle/ai/items.asm`, `engine/battle/ai/scoring.asm`, `engine/battle/read_trainer_attributes.asm`, +1 more |
...
| `Map Scripts 4` | ROMX | 45:4000-6f59 | 12122 | ROMX 45 | `data/maps/scripts.asm`, `maps/IlexForest.asm`, `maps/MahoganyMart1F.asm`, `maps/TeamRocketBaseB1F.asm`, +2 more |
...
| `Map Scripts 22` | ROMX | 57:4000-764a | 13899 | ROMX 57 | `data/maps/scripts.asm`, `maps/BillsFamilysHouse.asm`, `maps/DayCare.asm`, `maps/GoldenrodBikeShop.asm`, +17 more |
...
| --- | --- | --- |
| `BossAI_IncrementTurnsElapsed` | 0e:5561 | `engine/battle/ai/boss.asm:1` |
| `BossAI_RecordPlayerSwitch` | 0e:558a | `engine/battle/ai/boss.asm:26` |
| `BossAI_SelectMove` | 0e:62e5 | `engine/battle/ai/boss.asm:2204` |
| `BossAI_SwitchOrTryItem` | 0e:63d0 | `engine/battle/ai/boss.asm:2391` |
| `BossAI_ComputeSwitchConfidence` | 0e:6b02 | `engine/battle/ai/boss.asm:3709` |
| `BossAI_PredictPlayerSwitch` | 0e:6b82 | `engine/battle/ai/boss.asm:3782` |
| `BossAI_RecordRevealedPlayerMove` | 0e:56c6 | `engine/battle/ai/boss.asm:290` |
| `BossAI_CurrentEnemyMoveHasKOPressure` | 0e:665e | `engine/battle/ai/boss.asm:2840` |
| `BossAI_CurrentEnemyMovePressureScore` | 0e:6686 | `engine/battle/ai/boss.asm:2873` |
| `BossAI_PlayerHasPublicThreatVsEnemy` | 0e:64c5 | `engine/battle/ai/boss.asm:2555` |
| `BossAI_PublicEnemyFaster` | 0e:68b0 | `engine/battle/ai/boss.asm:3296` |
| `BossAI_CheckAbleToSwitchSafe` | 0e:647b | `engine/battle/ai/boss.asm:2499` |
| `BossAI_RefineSwitchCandidateForPlausibleRisk` | 0e:7736 | `engine/battle/ai/boss.asm:5936` |
| `BossAI_ApplyPlausibleRiskToSwitchConfidence` | 0e:796a | `engine/battle/ai/boss.asm:6308` |
| `BossAITierMap` | 0e:7d2d | `data/trainers/ai_tiers.asm:1` |
| `CheckPlayerMoveTypeMatchups` | 0d:4a79 | `engine/battle/ai/switch.asm:1` |
| `AICompareSpeed` | 0e:5260 | `engine/battle/ai/scoring.asm:2673` |
| `AIDamageCalc` | 0e:5415 | `engine/battle/ai/scoring.asm:3033` |
| `TypePassive_ApplyDamageModifiers_Far` | 0b:73d2 | `engine/battle/type_passive_damage_mods.asm:44` |
| `TypePassive_TryDarkStatusShield_Far` | 0b:795f | `engine/battle/type_passive_damage_mods.asm:1057` |
| `TypePassive_MaybePoisonRetaliation_Far` | 0b:79ae | `engine/battle/type_passive_damage_mods.asm:1118` |
| `ApplyLateGenDamageMultipliers_Far` | 0b:6f77 | `engine/battle/late_gen_held_items.asm:168` |
| `HandleLateGenAfterHitEffects_Far` | 0b:7032 | `engine/battle/late_gen_held_items.asm:289` |
...
| `MoveContactFlags` | 0b:7b21 | `data/moves/contact_flags.asm:4` |
...
| `IsChoiceHeldEffect_Far` | 0b:7332 | `engine/battle/late_gen_held_items.asm:797` |
| `IsMoveBlockedByAssaultVest_Far` | 0b:733b | `engine/battle/late_gen_held_items.asm:805` |
...
| `TMTutorTeachAnyTM` | 0b:4bf5 | `engine/events/tm_tutor.asm:1` |
