...
- Anchors: `BossAI_IncrementTurnsElapsed` (0e:454d, `engine/battle/ai/boss_platform.asm:24`); `BossAI_RecordPlayerSwitch` (0e:45db, `engine/battle/ai/boss_platform.asm:126`); `BossAI_SelectMove` (0e:57bf, `engine/battle/ai/boss_policy_move.asm:2677`); `BossAI_SwitchOrTryItem` (0e:58b1, `engine/battle/ai/boss_policy_switch.asm:17`); `BossAI_ComputeSwitchConfidence` (0e:6530, `engine/battle/ai/boss_policy_switch.asm:751`); `BossAI_PredictPlayerSwitch` (0e:65b3, `engine/battle/ai/boss_policy_move.asm:3605`); `BossAI_RecordRevealedPlayerMove` (0e:4717, `engine/battle/ai/boss_platform.asm:260`); `BossAI_CurrentEnemyMoveHasKOPressure` (0e:6015, `engine/battle/ai/boss_policy_move.asm:3043`); `BossAI_CurrentEnemyMovePressureScore` (0e:603d, `engine/battle/ai/boss_policy_move.asm:3077`); `BossAI_PlayerHasPublicThreatVsEnemy` (0e:5e7e, `engine/battle/ai/boss_policy_move.asm:2885`); `BossAI_PublicEnemyFaster` (0e:62d9, `engine/battle/ai/boss_policy_move.asm:3530`); `BossAI_CheckAbleToSwitchSafe` (0e:5a4e, `engine/battle/ai/boss_policy_switch.asm:298`); `BossAI_RefineSwitchCandidateForPlausibleRisk` (0e:747d, `engine/battle/ai/boss_policy_switch.asm:833`); `BossAI_ApplyPlausibleRiskToSwitchConfidence` (0e:76b1, `engine/battle/ai/boss_policy_switch.asm:1216`)
...
| `Enemy Trainers` | ROMX | 0e:4000-7e23 | 15908 | ROMX 0e | `engine/battle/ai/boss_platform.asm`, `engine/battle/ai/boss_policy_move.asm`, `engine/battle/ai/boss_policy_switch.asm`, `engine/battle/ai/boss_thunks.asm`, +6 more |
...
| `BossAI_ComputeSwitchConfidence` | 0e:6530 | `engine/battle/ai/boss_policy_switch.asm:751` |
| `BossAI_PredictPlayerSwitch` | 0e:65b3 | `engine/battle/ai/boss_policy_move.asm:3605` |
| `BossAI_RecordRevealedPlayerMove` | 0e:4717 | `engine/battle/ai/boss_platform.asm:260` |
| `BossAI_CurrentEnemyMoveHasKOPressure` | 0e:6015 | `engine/battle/ai/boss_policy_move.asm:3043` |
| `BossAI_CurrentEnemyMovePressureScore` | 0e:603d | `engine/battle/ai/boss_policy_move.asm:3077` |
| `BossAI_PlayerHasPublicThreatVsEnemy` | 0e:5e7e | `engine/battle/ai/boss_policy_move.asm:2885` |
| `BossAI_PublicEnemyFaster` | 0e:62d9 | `engine/battle/ai/boss_policy_move.asm:3530` |
| `BossAI_CheckAbleToSwitchSafe` | 0e:5a4e | `engine/battle/ai/boss_policy_switch.asm:298` |
| `BossAI_RefineSwitchCandidateForPlausibleRisk` | 0e:747d | `engine/battle/ai/boss_policy_switch.asm:833` |
| `BossAI_ApplyPlausibleRiskToSwitchConfidence` | 0e:76b1 | `engine/battle/ai/boss_policy_switch.asm:1216` |
| `BossAITierMap` | 0e:7d5e | `data/trainers/ai_tiers.asm:1` |
