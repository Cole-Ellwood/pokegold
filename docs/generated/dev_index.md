...
- Anchors: `BossAI_IncrementTurnsElapsed` (0e:454d, `engine/battle/ai/boss_platform.asm:24`); `BossAI_RecordPlayerSwitch` (0e:45db, `engine/battle/ai/boss_platform.asm:126`); `BossAI_SelectMove` (0e:57b9, `engine/battle/ai/boss_policy_move.asm:2674`); `BossAI_SwitchOrTryItem` (0e:58ab, `engine/battle/ai/boss_policy_switch.asm:17`); `BossAI_ComputeSwitchConfidence` (0e:653a, `engine/battle/ai/boss_policy_switch.asm:751`); `BossAI_PredictPlayerSwitch` (0e:65b9, `engine/battle/ai/boss_policy_move.asm:3602`); `BossAI_RecordRevealedPlayerMove` (0e:4717, `engine/battle/ai/boss_platform.asm:260`); `BossAI_CurrentEnemyMoveHasKOPressure` (0e:601f, `engine/battle/ai/boss_policy_move.asm:3040`); `BossAI_CurrentEnemyMovePressureScore` (0e:6047, `engine/battle/ai/boss_policy_move.asm:3074`); `BossAI_PlayerHasPublicThreatVsEnemy` (0e:5e88, `engine/battle/ai/boss_policy_move.asm:2882`); `BossAI_PublicEnemyFaster` (0e:62e3, `engine/battle/ai/boss_policy_move.asm:3527`); `BossAI_CheckAbleToSwitchSafe` (0e:5a48, `engine/battle/ai/boss_policy_switch.asm:298`); `BossAI_RefineSwitchCandidateForPlausibleRisk` (0e:72e9, `engine/battle/ai/boss_policy_switch.asm:831`); `BossAI_ApplyPlausibleRiskToSwitchConfidence` (0e:751d, `engine/battle/ai/boss_policy_switch.asm:1214`)
...
| `Enemy Trainers` | ROMX | 0e:4000-7aa4 | 15013 | ROMX 0e | `engine/battle/ai/boss_platform.asm`, `engine/battle/ai/boss_policy_move.asm`, `engine/battle/ai/boss_policy_switch.asm`, `engine/battle/ai/boss_thunks.asm`, +6 more |
...
| `BossAI_PredictPlayerSwitch` | 0e:65b9 | `engine/battle/ai/boss_policy_move.asm:3602` |
...
| `BossAI_RefineSwitchCandidateForPlausibleRisk` | 0e:72e9 | `engine/battle/ai/boss_policy_switch.asm:831` |
| `BossAI_ApplyPlausibleRiskToSwitchConfidence` | 0e:751d | `engine/battle/ai/boss_policy_switch.asm:1214` |
| `BossAITierMap` | 0e:79df | `data/trainers/ai_tiers.asm:1` |
