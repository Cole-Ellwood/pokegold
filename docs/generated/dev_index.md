...
- Anchors: `BossAI_IncrementTurnsElapsed` (0e:4198, `engine/battle/ai/boss_platform.asm:24`); `BossAI_RecordPlayerSwitch` (0e:423e, `engine/battle/ai/boss_platform.asm:153`); `BossAI_SelectMove` (0e:54bb, `engine/battle/ai/boss_policy_move.asm:2815`); `BossAI_TrySwitch` (0e:568e, `engine/battle/ai/boss_policy_switch.asm:17`); `BossAI_ComputeSwitchConfidence` (0e:63ed, `engine/battle/ai/boss_policy_switch.asm:1029`); `BossAI_PredictPlayerSwitch` (0e:6463, `engine/battle/ai/boss_policy_move.asm:4130`); `BossAI_RecordRevealedPlayerMove` (0e:4391, `engine/battle/ai/boss_platform.asm:303`); `BossAI_CurrentEnemyMoveHasKOPressure` (0e:5e6b, `engine/battle/ai/boss_policy_move.asm:3319`); `BossAI_CurrentEnemyMovePressureScore` (0e:5e7c, `engine/battle/ai/boss_policy_move.asm:3331`); `BossAI_PlayerHasPublicThreatVsEnemy` (0e:5cd5, `engine/battle/ai/boss_policy_move.asm:3179`); `BossAI_PublicEnemyFaster` (0e:623e, `engine/battle/ai/boss_policy_move.asm:4035`); `BossAI_CheckAbleToSwitchSafe` (0e:595e, `engine/battle/ai/boss_policy_switch.asm:559`); `BossAI_RefineSwitchCandidateForPlausibleRisk` (0e:738d, `engine/battle/ai/boss_policy_switch.asm:1110`); `BossAI_ApplyPlausibleRiskToSwitchConfidence` (0e:75bc, `engine/battle/ai/boss_policy_switch.asm:1491`)
...
| `Enemy Trainers` | ROMX | 0e:4000-7f65 | 16230 | ROMX 0e | `engine/battle/ai/boss_platform.asm`, `engine/battle/ai/boss_policy_move.asm`, `engine/battle/ai/boss_policy_switch.asm`, `engine/battle/ai/boss_thunks.asm`, +6 more |
...
| `BossAI_RecordPlayerSwitch` | 0e:423e | `engine/battle/ai/boss_platform.asm:153` |
| `BossAI_SelectMove` | 0e:54bb | `engine/battle/ai/boss_policy_move.asm:2815` |
| `BossAI_TrySwitch` | 0e:568e | `engine/battle/ai/boss_policy_switch.asm:17` |
| `BossAI_ComputeSwitchConfidence` | 0e:63ed | `engine/battle/ai/boss_policy_switch.asm:1029` |
| `BossAI_PredictPlayerSwitch` | 0e:6463 | `engine/battle/ai/boss_policy_move.asm:4130` |
| `BossAI_RecordRevealedPlayerMove` | 0e:4391 | `engine/battle/ai/boss_platform.asm:303` |
| `BossAI_CurrentEnemyMoveHasKOPressure` | 0e:5e6b | `engine/battle/ai/boss_policy_move.asm:3319` |
| `BossAI_CurrentEnemyMovePressureScore` | 0e:5e7c | `engine/battle/ai/boss_policy_move.asm:3331` |
| `BossAI_PlayerHasPublicThreatVsEnemy` | 0e:5cd5 | `engine/battle/ai/boss_policy_move.asm:3179` |
| `BossAI_PublicEnemyFaster` | 0e:623e | `engine/battle/ai/boss_policy_move.asm:4035` |
| `BossAI_CheckAbleToSwitchSafe` | 0e:595e | `engine/battle/ai/boss_policy_switch.asm:559` |
| `BossAI_RefineSwitchCandidateForPlausibleRisk` | 0e:738d | `engine/battle/ai/boss_policy_switch.asm:1110` |
| `BossAI_ApplyPlausibleRiskToSwitchConfidence` | 0e:75bc | `engine/battle/ai/boss_policy_switch.asm:1491` |
| `BossAITierMap` | 0e:7ea0 | `data/trainers/ai_tiers.asm:1` |
| `CheckPlayerMoveTypeMatchups` | 0d:49e5 | `engine/battle/ai/switch.asm:1` |
| `AICompareSpeed` | 11:7307 | `engine/battle/ai/scoring.asm:2650` |
| `AIDamageCalc` | 11:74bc | `engine/battle/ai/scoring.asm:2977` |
