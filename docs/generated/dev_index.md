...
- Anchors: `BossAI_IncrementTurnsElapsed` (0e:45b5, `engine/battle/ai/boss.asm:8`); `BossAI_RecordPlayerSwitch` (0e:45de, `engine/battle/ai/boss.asm:34`); `BossAI_SelectMove` (0e:53ce, `engine/battle/ai/boss.asm:2394`); `BossAI_SwitchOrTryItem` (0e:54b9, `engine/battle/ai/boss.asm:2593`); `BossAI_ComputeSwitchConfidence` (0e:5c81, `engine/battle/ai/boss.asm:4123`); `BossAI_PredictPlayerSwitch` (0e:5d01, `engine/battle/ai/boss.asm:4203`); `BossAI_RecordRevealedPlayerMove` (0e:471a, `engine/battle/ai/boss.asm:317`); `BossAI_CurrentEnemyMoveHasKOPressure` (0e:5774, `engine/battle/ai/boss.asm:3111`); `BossAI_CurrentEnemyMovePressureScore` (0e:579c, `engine/battle/ai/boss.asm:3145`); `BossAI_PlayerHasPublicThreatVsEnemy` (0e:55b1, `engine/battle/ai/boss.asm:2773`); `BossAI_PublicEnemyFaster` (0e:5a2a, `engine/battle/ai/boss.asm:3672`); `BossAI_CheckAbleToSwitchSafe` (0e:5567, `engine/battle/ai/boss.asm:2709`); `BossAI_RefineSwitchCandidateForPlausibleRisk` (0e:69db, `engine/battle/ai/boss.asm:6790`); `BossAI_ApplyPlausibleRiskToSwitchConfidence` (0e:6c0f, `engine/battle/ai/boss.asm:7170`)
...
- Anchors: `TypePassive_ApplyDamageModifiers_Far` (0e:7631, `engine/battle/type_passive_damage_mods.asm:44`); `TypePassive_TryDarkStatusShield_Far` (0e:7bbb, `engine/battle/type_passive_damage_mods.asm:1070`); `TypePassive_MaybePoisonRetaliation_Far` (0e:7c0a, `engine/battle/type_passive_damage_mods.asm:1131`); `ApplyLateGenDamageMultipliers_Far` (0e:71c7, `engine/battle/late_gen_held_items.asm:183`); `HandleLateGenAfterHitEffects_Far` (0e:7280, `engine/battle/late_gen_held_items.asm:301`); `TryActivateDittoImposter` (01:7a10, `engine/battle/ditto_imposter.asm:1`)
...
- Anchors: `Moves` (10:5af6, `data/moves/moves.asm:14`); `MoveEffects` (09:750c, `data/moves/effects.asm:3`); `MoveContactFlags` (0e:7d79, `data/moves/contact_flags.asm:4`); `Spikes` (09:7a28, `data/moves/effects.asm:1525`); `RapidSpin` (09:7afd, `data/moves/effects.asm:1772`)
...
| `Late Gen Held Items` | ROMX | 0e:70f2-7e76 | 3461 |  | `engine/battle/late_gen_held_items.asm`, `engine/battle/type_passive_damage_mods.asm`, `main.asm` |
...
| `BossAI_ComputeSwitchConfidence` | 0e:5c81 | `engine/battle/ai/boss.asm:4123` |
| `BossAI_PredictPlayerSwitch` | 0e:5d01 | `engine/battle/ai/boss.asm:4203` |
...
| `BossAI_PublicEnemyFaster` | 0e:5a2a | `engine/battle/ai/boss.asm:3672` |
| `BossAI_CheckAbleToSwitchSafe` | 0e:5567 | `engine/battle/ai/boss.asm:2709` |
| `BossAI_RefineSwitchCandidateForPlausibleRisk` | 0e:69db | `engine/battle/ai/boss.asm:6790` |
| `BossAI_ApplyPlausibleRiskToSwitchConfidence` | 0e:6c0f | `engine/battle/ai/boss.asm:7170` |
...
| `TypePassive_TryDarkStatusShield_Far` | 0e:7bbb | `engine/battle/type_passive_damage_mods.asm:1070` |
| `TypePassive_MaybePoisonRetaliation_Far` | 0e:7c0a | `engine/battle/type_passive_damage_mods.asm:1131` |
| `ApplyLateGenDamageMultipliers_Far` | 0e:71c7 | `engine/battle/late_gen_held_items.asm:183` |
| `HandleLateGenAfterHitEffects_Far` | 0e:7280 | `engine/battle/late_gen_held_items.asm:301` |
| `TryActivateDittoImposter` | 01:7a10 | `engine/battle/ditto_imposter.asm:1` |
| `Moves` | 10:5af6 | `data/moves/moves.asm:14` |
| `MoveEffects` | 09:750c | `data/moves/effects.asm:3` |
| `MoveContactFlags` | 0e:7d79 | `data/moves/contact_flags.asm:4` |
...
| `IsChoiceHeldEffect_Far` | 0e:7578 | `engine/battle/late_gen_held_items.asm:819` |
| `IsMoveBlockedByAssaultVest_Far` | 0e:7581 | `engine/battle/late_gen_held_items.asm:827` |
