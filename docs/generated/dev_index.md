...
- Anchors: `BossAI_IncrementTurnsElapsed` (0e:44ae, `engine/battle/ai/boss_platform.asm:24`); `BossAI_RecordPlayerSwitch` (0e:453c, `engine/battle/ai/boss_platform.asm:126`); `BossAI_SelectMove` (0e:5741, `engine/battle/ai/boss_policy_move.asm:2778`); `BossAI_SwitchOrTryItem` (0e:5833, `engine/battle/ai/boss_policy_switch.asm:17`); `BossAI_ComputeSwitchConfidence` (0e:6480, `engine/battle/ai/boss_policy_switch.asm:878`); `BossAI_PredictPlayerSwitch` (0e:6503, `engine/battle/ai/boss_policy_move.asm:3737`); `BossAI_RecordRevealedPlayerMove` (0e:4678, `engine/battle/ai/boss_platform.asm:260`); `BossAI_CurrentEnemyMoveHasKOPressure` (0e:5f9f, `engine/battle/ai/boss_policy_move.asm:3144`); `BossAI_CurrentEnemyMovePressureScore` (0e:5fc7, `engine/battle/ai/boss_policy_move.asm:3178`); `BossAI_PlayerHasPublicThreatVsEnemy` (0e:5de9, `engine/battle/ai/boss_policy_move.asm:2986`); `BossAI_PublicEnemyFaster` (0e:6277, `engine/battle/ai/boss_policy_move.asm:3642`); `BossAI_CheckAbleToSwitchSafe` (0e:5ae6, `engine/battle/ai/boss_policy_switch.asm:504`); `BossAI_RefineSwitchCandidateForPlausibleRisk` (0e:7422, `engine/battle/ai/boss_policy_switch.asm:960`); `BossAI_ApplyPlausibleRiskToSwitchConfidence` (0e:7656, `engine/battle/ai/boss_policy_switch.asm:1343`)
...
- Anchors: `TypePassive_ApplyDamageModifiers_Far` (11:6b4a, `engine/battle/type_passive_damage_mods.asm:44`); `TypePassive_TryDarkStatusShield_Far` (11:70cf, `engine/battle/type_passive_damage_mods.asm:1069`); `TypePassive_MaybePoisonRetaliation_Far` (11:712c, `engine/battle/type_passive_damage_mods.asm:1135`); `ApplyLateGenDamageMultipliers_Far` (11:66d8, `engine/battle/late_gen_held_items.asm:183`); `HandleLateGenAfterHitEffects_Far` (11:6791, `engine/battle/late_gen_held_items.asm:301`); `TryActivateDittoImposter` (01:79a2, `engine/battle/ditto_imposter.asm:1`)
...
- Anchors: `Moves` (10:5aaa, `data/moves/moves.asm:14`); `MoveEffects` (09:7489, `data/moves/effects.asm:3`); `MoveContactFlags` (11:72ba, `data/moves/contact_flags.asm:4`); `Spikes` (09:79a5, `data/moves/effects.asm:1525`); `RapidSpin` (09:7a7a, `data/moves/effects.asm:1772`)
...
| --- | ---: | ---: |
| Normal | 111 | 29 |
| With `BOSS_AI_TRACE` fields | 138 | 2 |
...
| `wBossAIStateEnd` | 01:d6fd | Logical end before reserve padding |
...
| `Enemy Trainers` | ROMX | 0e:4000-7d61 | 15714 | ROMX 0e | `engine/battle/ai/boss_platform.asm`, `engine/battle/ai/boss_policy_move.asm`, `engine/battle/ai/boss_policy_switch.asm`, `engine/battle/ai/boss_thunks.asm`, +6 more |
| `Battle Core` | ROMX | 0f:4000-7b0c | 15117 | ROMX 0f | `engine/battle/core.asm`, `main.asm` |
...
| `Late Gen Held Items` | ROMX | 11:6603-73b7 | 3509 |  | `engine/battle/late_gen_held_items.asm`, `engine/battle/type_passive_damage_mods.asm`, `main.asm` |
...
| `BossAI_SelectMove` | 0e:5741 | `engine/battle/ai/boss_policy_move.asm:2778` |
| `BossAI_SwitchOrTryItem` | 0e:5833 | `engine/battle/ai/boss_policy_switch.asm:17` |
| `BossAI_ComputeSwitchConfidence` | 0e:6480 | `engine/battle/ai/boss_policy_switch.asm:878` |
| `BossAI_PredictPlayerSwitch` | 0e:6503 | `engine/battle/ai/boss_policy_move.asm:3737` |
| `BossAI_RecordRevealedPlayerMove` | 0e:4678 | `engine/battle/ai/boss_platform.asm:260` |
| `BossAI_CurrentEnemyMoveHasKOPressure` | 0e:5f9f | `engine/battle/ai/boss_policy_move.asm:3144` |
| `BossAI_CurrentEnemyMovePressureScore` | 0e:5fc7 | `engine/battle/ai/boss_policy_move.asm:3178` |
| `BossAI_PlayerHasPublicThreatVsEnemy` | 0e:5de9 | `engine/battle/ai/boss_policy_move.asm:2986` |
| `BossAI_PublicEnemyFaster` | 0e:6277 | `engine/battle/ai/boss_policy_move.asm:3642` |
| `BossAI_CheckAbleToSwitchSafe` | 0e:5ae6 | `engine/battle/ai/boss_policy_switch.asm:504` |
| `BossAI_RefineSwitchCandidateForPlausibleRisk` | 0e:7422 | `engine/battle/ai/boss_policy_switch.asm:960` |
| `BossAI_ApplyPlausibleRiskToSwitchConfidence` | 0e:7656 | `engine/battle/ai/boss_policy_switch.asm:1343` |
| `BossAITierMap` | 0e:7c9c | `data/trainers/ai_tiers.asm:1` |
...
| `TypePassive_ApplyDamageModifiers_Far` | 11:6b4a | `engine/battle/type_passive_damage_mods.asm:44` |
| `TypePassive_TryDarkStatusShield_Far` | 11:70cf | `engine/battle/type_passive_damage_mods.asm:1069` |
| `TypePassive_MaybePoisonRetaliation_Far` | 11:712c | `engine/battle/type_passive_damage_mods.asm:1135` |
| `ApplyLateGenDamageMultipliers_Far` | 11:66d8 | `engine/battle/late_gen_held_items.asm:183` |
| `HandleLateGenAfterHitEffects_Far` | 11:6791 | `engine/battle/late_gen_held_items.asm:301` |
| `TryActivateDittoImposter` | 01:79a2 | `engine/battle/ditto_imposter.asm:1` |
| `Moves` | 10:5aaa | `data/moves/moves.asm:14` |
| `MoveEffects` | 09:7489 | `data/moves/effects.asm:3` |
| `MoveContactFlags` | 11:72ba | `data/moves/contact_flags.asm:4` |
...
| `IsChoiceHeldEffect_Far` | 11:6a89 | `engine/battle/late_gen_held_items.asm:819` |
| `IsMoveBlockedByAssaultVest_Far` | 11:6a96 | `engine/battle/late_gen_held_items.asm:831` |
