...
| `Enemy Trainers` | ROMX | 0e:4000-7eff | 16128 | ROMX 0e | `engine/battle/ai/boss_platform.asm`, `engine/battle/ai/boss_policy_move.asm`, `engine/battle/ai/boss_policy_switch.asm`, `engine/battle/ai/boss_thunks.asm`, +6 more |
...
| `BossAI_RefineSwitchCandidateForPlausibleRisk` | 0e:7331 | `engine/battle/ai/boss_policy_switch.asm:1105` |
| `BossAI_ApplyPlausibleRiskToSwitchConfidence` | 0e:7556 | `engine/battle/ai/boss_policy_switch.asm:1477` |
| `BossAITierMap` | 0e:7e3a | `data/trainers/ai_tiers.asm:1` |
