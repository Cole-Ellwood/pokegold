...
- Anchors: `BossAI_IncrementTurnsElapsed` (0e:4198, `engine/battle/ai/boss_platform.asm:24`); `BossAI_RecordPlayerSwitch` (0e:423e, `engine/battle/ai/boss_platform.asm:153`); `BossAI_SelectMove` (0e:54bb, `engine/battle/ai/boss_policy_move.asm:2815`); `BossAI_TrySwitch` (0e:568e, `engine/battle/ai/boss_policy_switch.asm:17`); `BossAI_ComputeSwitchConfidence` (0e:63d1, `engine/battle/ai/boss_policy_switch.asm:1003`); `BossAI_PredictPlayerSwitch` (0e:6447, `engine/battle/ai/boss_policy_move.asm:4129`); `BossAI_RecordRevealedPlayerMove` (0e:4391, `engine/battle/ai/boss_platform.asm:303`); `BossAI_CurrentEnemyMoveHasKOPressure` (0e:5e57, `engine/battle/ai/boss_policy_move.asm:3319`); `BossAI_CurrentEnemyMovePressureScore` (0e:5e68, `engine/battle/ai/boss_policy_move.asm:3331`); `BossAI_PlayerHasPublicThreatVsEnemy` (0e:5cc1, `engine/battle/ai/boss_policy_move.asm:3179`); `BossAI_PublicEnemyFaster` (0e:6228, `engine/battle/ai/boss_policy_move.asm:4034`); `BossAI_CheckAbleToSwitchSafe` (0e:594a, `engine/battle/ai/boss_policy_switch.asm:541`); `BossAI_RefineSwitchCandidateForPlausibleRisk` (0e:736f, `engine/battle/ai/boss_policy_switch.asm:1084`); `BossAI_ApplyPlausibleRiskToSwitchConfidence` (0e:759e, `engine/battle/ai/boss_policy_switch.asm:1465`)
...
| `Enemy Trainers` | ROMX | 0e:4000-7f3b | 16188 | ROMX 0e | `engine/battle/ai/boss_platform.asm`, `engine/battle/ai/boss_policy_move.asm`, `engine/battle/ai/boss_policy_switch.asm`, `engine/battle/ai/boss_thunks.asm`, +6 more |
...
| `BossAI_ComputeSwitchConfidence` | 0e:63d1 | `engine/battle/ai/boss_policy_switch.asm:1003` |
| `BossAI_PredictPlayerSwitch` | 0e:6447 | `engine/battle/ai/boss_policy_move.asm:4129` |
| `BossAI_RecordRevealedPlayerMove` | 0e:4391 | `engine/battle/ai/boss_platform.asm:303` |
| `BossAI_CurrentEnemyMoveHasKOPressure` | 0e:5e57 | `engine/battle/ai/boss_policy_move.asm:3319` |
| `BossAI_CurrentEnemyMovePressureScore` | 0e:5e68 | `engine/battle/ai/boss_policy_move.asm:3331` |
| `BossAI_PlayerHasPublicThreatVsEnemy` | 0e:5cc1 | `engine/battle/ai/boss_policy_move.asm:3179` |
| `BossAI_PublicEnemyFaster` | 0e:6228 | `engine/battle/ai/boss_policy_move.asm:4034` |
| `BossAI_CheckAbleToSwitchSafe` | 0e:594a | `engine/battle/ai/boss_policy_switch.asm:541` |
| `BossAI_RefineSwitchCandidateForPlausibleRisk` | 0e:736f | `engine/battle/ai/boss_policy_switch.asm:1084` |
| `BossAI_ApplyPlausibleRiskToSwitchConfidence` | 0e:759e | `engine/battle/ai/boss_policy_switch.asm:1465` |
| `BossAITierMap` | 0e:7e76 | `data/trainers/ai_tiers.asm:1` |
