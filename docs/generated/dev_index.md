...
- Anchors: `TypePassive_ApplyDamageModifiers_Far` (0e:75c5, `engine/battle/type_passive_damage_mods.asm:44`); `TypePassive_TryDarkStatusShield_Far` (0e:7b4b, `engine/battle/type_passive_damage_mods.asm:1070`); `TypePassive_MaybePoisonRetaliation_Far` (0e:7b9a, `engine/battle/type_passive_damage_mods.asm:1131`); `ApplyLateGenDamageMultipliers_Far` (0e:715b, `engine/battle/late_gen_held_items.asm:183`); `HandleLateGenAfterHitEffects_Far` (0e:7214, `engine/battle/late_gen_held_items.asm:301`); `TryActivateDittoImposter` (01:7a10, `engine/battle/ditto_imposter.asm:1`)
...
| `BossAI_ComputeSwitchConfidence` | 0e:5c1d | `engine/battle/ai/boss.asm:3960` |
| `BossAI_PredictPlayerSwitch` | 0e:5c9d | `engine/battle/ai/boss.asm:4033` |
...
| `BossAI_PublicEnemyFaster` | 0e:59c6 | `engine/battle/ai/boss.asm:3543` |
| `BossAI_CheckAbleToSwitchSafe` | 0e:5567 | `engine/battle/ai/boss.asm:2636` |
| `BossAI_RefineSwitchCandidateForPlausibleRisk` | 0e:6977 | `engine/battle/ai/boss.asm:6431` |
| `BossAI_ApplyPlausibleRiskToSwitchConfidence` | 0e:6bab | `engine/battle/ai/boss.asm:6803` |
...
| `TypePassive_TryDarkStatusShield_Far` | 0e:7b4b | `engine/battle/type_passive_damage_mods.asm:1070` |
| `TypePassive_MaybePoisonRetaliation_Far` | 0e:7b9a | `engine/battle/type_passive_damage_mods.asm:1131` |
| `ApplyLateGenDamageMultipliers_Far` | 0e:715b | `engine/battle/late_gen_held_items.asm:183` |
| `HandleLateGenAfterHitEffects_Far` | 0e:7214 | `engine/battle/late_gen_held_items.asm:301` |
| `TryActivateDittoImposter` | 01:7a10 | `engine/battle/ditto_imposter.asm:1` |
...
| `IsChoiceHeldEffect_Far` | 0e:750c | `engine/battle/late_gen_held_items.asm:819` |
| `IsMoveBlockedByAssaultVest_Far` | 0e:7515 | `engine/battle/late_gen_held_items.asm:827` |
