...
- Anchors: `BossAI_IncrementTurnsElapsed` (0e:454d, `engine/battle/ai/boss_platform.asm:24`); `BossAI_RecordPlayerSwitch` (0e:459b, `engine/battle/ai/boss_platform.asm:75`); `BossAI_SelectMove` (0e:5753, `engine/battle/ai/boss_policy_move.asm:2621`); `BossAI_SwitchOrTryItem` (0e:5845, `engine/battle/ai/boss_policy_switch.asm:17`); `BossAI_ComputeSwitchConfidence` (0e:607e, `engine/battle/ai/boss_policy_switch.asm:685`); `BossAI_PredictPlayerSwitch` (0e:60fd, `engine/battle/ai/boss_policy_move.asm:3541`); `BossAI_RecordRevealedPlayerMove` (0e:46d7, `engine/battle/ai/boss_platform.asm:209`); `BossAI_CurrentEnemyMoveHasKOPressure` (0e:5b71, `engine/battle/ai/boss_policy_move.asm:2987`); `BossAI_CurrentEnemyMovePressureScore` (0e:5b99, `engine/battle/ai/boss_policy_move.asm:3021`); `BossAI_PlayerHasPublicThreatVsEnemy` (0e:59da, `engine/battle/ai/boss_policy_move.asm:2829`); `BossAI_PublicEnemyFaster` (0e:5e27, `engine/battle/ai/boss_policy_move.asm:3466`); `BossAI_CheckAbleToSwitchSafe` (0e:5992, `engine/battle/ai/boss_policy_switch.asm:232`); `BossAI_RefineSwitchCandidateForPlausibleRisk` (0e:6e1f, `engine/battle/ai/boss_policy_switch.asm:765`); `BossAI_ApplyPlausibleRiskToSwitchConfidence` (0e:7053, `engine/battle/ai/boss_policy_switch.asm:1148`)
...
- Anchors: `TypePassive_ApplyDamageModifiers_Far` (11:507a, `engine/battle/type_passive_damage_mods.asm:44`); `TypePassive_TryDarkStatusShield_Far` (11:55ff, `engine/battle/type_passive_damage_mods.asm:1069`); `TypePassive_MaybePoisonRetaliation_Far` (11:565c, `engine/battle/type_passive_damage_mods.asm:1135`); `ApplyLateGenDamageMultipliers_Far` (11:4c0a, `engine/battle/late_gen_held_items.asm:183`); `HandleLateGenAfterHitEffects_Far` (11:4cc3, `engine/battle/late_gen_held_items.asm:301`); `TryActivateDittoImposter` (01:799b, `engine/battle/ditto_imposter.asm:1`)
...
- Anchors: `Moves` (10:5aaa, `data/moves/moves.asm:14`); `MoveEffects` (09:7489, `data/moves/effects.asm:3`); `MoveContactFlags` (11:57dd, `data/moves/contact_flags.asm:4`); `Spikes` (09:79a5, `data/moves/effects.asm:1525`); `RapidSpin` (09:7a7a, `data/moves/effects.asm:1772`)
...
- Anchors: `BaseData` (14:5acb, `data/pokemon/base_stats.asm:21`); `EvosAttacksPointers` (10:685c, `data/pokemon/evos_attacks_pointers.asm:3`); `EggMovePointers` (08:79f0, `data/pokemon/egg_move_pointers.asm:1`)
...
| `Enemy Trainers` | ROMX | 0e:4000-7590 | 13713 | ROMX 0e | `engine/battle/ai/boss_platform.asm`, `engine/battle/ai/boss_policy_move.asm`, `engine/battle/ai/boss_policy_switch.asm`, `engine/battle/ai/boss_thunks.asm`, +3 more |
| `Battle Core` | ROMX | 0f:4000-7aca | 15051 | ROMX 0f | `engine/battle/core.asm`, `main.asm` |
...
| `Late Gen Held Items` | ROMX | 11:4b35-58da | 3494 |  | `engine/battle/late_gen_held_items.asm`, `engine/battle/type_passive_damage_mods.asm`, `main.asm` |
...
| `Map Scripts 21` | ROMX | 56:4000-7572 | 13683 | ROMX 56 | `data/maps/scripts.asm`, `maps/EarlsPokemonAcademy.asm`, `maps/Route32Pokecenter1F.asm`, `maps/Route32RuinsOfAlphGate.asm`, +9 more |
...
| `BossAI_SelectMove` | 0e:5753 | `engine/battle/ai/boss_policy_move.asm:2621` |
| `BossAI_SwitchOrTryItem` | 0e:5845 | `engine/battle/ai/boss_policy_switch.asm:17` |
| `BossAI_ComputeSwitchConfidence` | 0e:607e | `engine/battle/ai/boss_policy_switch.asm:685` |
| `BossAI_PredictPlayerSwitch` | 0e:60fd | `engine/battle/ai/boss_policy_move.asm:3541` |
| `BossAI_RecordRevealedPlayerMove` | 0e:46d7 | `engine/battle/ai/boss_platform.asm:209` |
| `BossAI_CurrentEnemyMoveHasKOPressure` | 0e:5b71 | `engine/battle/ai/boss_policy_move.asm:2987` |
| `BossAI_CurrentEnemyMovePressureScore` | 0e:5b99 | `engine/battle/ai/boss_policy_move.asm:3021` |
| `BossAI_PlayerHasPublicThreatVsEnemy` | 0e:59da | `engine/battle/ai/boss_policy_move.asm:2829` |
| `BossAI_PublicEnemyFaster` | 0e:5e27 | `engine/battle/ai/boss_policy_move.asm:3466` |
| `BossAI_CheckAbleToSwitchSafe` | 0e:5992 | `engine/battle/ai/boss_policy_switch.asm:232` |
| `BossAI_RefineSwitchCandidateForPlausibleRisk` | 0e:6e1f | `engine/battle/ai/boss_policy_switch.asm:765` |
| `BossAI_ApplyPlausibleRiskToSwitchConfidence` | 0e:7053 | `engine/battle/ai/boss_policy_switch.asm:1148` |
| `BossAITierMap` | 0e:74e5 | `data/trainers/ai_tiers.asm:1` |
...
| `TypePassive_ApplyDamageModifiers_Far` | 11:507a | `engine/battle/type_passive_damage_mods.asm:44` |
| `TypePassive_TryDarkStatusShield_Far` | 11:55ff | `engine/battle/type_passive_damage_mods.asm:1069` |
| `TypePassive_MaybePoisonRetaliation_Far` | 11:565c | `engine/battle/type_passive_damage_mods.asm:1135` |
| `ApplyLateGenDamageMultipliers_Far` | 11:4c0a | `engine/battle/late_gen_held_items.asm:183` |
| `HandleLateGenAfterHitEffects_Far` | 11:4cc3 | `engine/battle/late_gen_held_items.asm:301` |
| `TryActivateDittoImposter` | 01:799b | `engine/battle/ditto_imposter.asm:1` |
| `Moves` | 10:5aaa | `data/moves/moves.asm:14` |
| `MoveEffects` | 09:7489 | `data/moves/effects.asm:3` |
| `MoveContactFlags` | 11:57dd | `data/moves/contact_flags.asm:4` |
...
| `IsChoiceHeldEffect_Far` | 11:4fbb | `engine/battle/late_gen_held_items.asm:819` |
| `IsMoveBlockedByAssaultVest_Far` | 11:4fc7 | `engine/battle/late_gen_held_items.asm:831` |
| `BaseData` | 14:5acb | `data/pokemon/base_stats.asm:21` |
