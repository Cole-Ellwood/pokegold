...
- Anchors: `BossAI_IncrementTurnsElapsed` (0e:4183, `engine/battle/ai/boss_platform.asm:24`); `BossAI_RecordPlayerSwitch` (0e:4231, `engine/battle/ai/boss_platform.asm:165`); `BossAI_SelectMove` (0e:54cb, `engine/battle/ai/boss_policy_move.asm:2827`); `BossAI_TrySwitch` (0e:567a, `engine/battle/ai/boss_policy_switch.asm:17`); `BossAI_ComputeSwitchConfidence` (0e:63d7, `engine/battle/ai/boss_policy_switch.asm:1031`); `BossAI_PredictPlayerSwitch` (0e:6446, `engine/battle/ai/boss_policy_move.asm:4109`); `BossAI_RecordRevealedPlayerMove` (0e:4384, `engine/battle/ai/boss_platform.asm:315`); `BossAI_CurrentEnemyMoveHasKOPressure` (0e:5e53, `engine/battle/ai/boss_policy_move.asm:3300`); `BossAI_CurrentEnemyMovePressureScore` (0e:5e64, `engine/battle/ai/boss_policy_move.asm:3312`); `BossAI_PlayerHasPublicThreatVsEnemy` (0e:5cc1, `engine/battle/ai/boss_policy_move.asm:3163`); `BossAI_PublicEnemyFaster` (0e:6226, `engine/battle/ai/boss_policy_move.asm:4015`); `BossAI_CheckAbleToSwitchSafe` (0e:594e, `engine/battle/ai/boss_policy_switch.asm:561`); `BossAI_RefineSwitchCandidateForPlausibleRisk` (0e:72b1, `engine/battle/ai/boss_policy_switch.asm:1107`); `BossAI_ApplyPlausibleRiskToSwitchConfidence` (0e:74d6, `engine/battle/ai/boss_policy_switch.asm:1479`)
...
- Anchors: `TypePassive_ApplyDamageModifiers_Far` (13:4523, `engine/battle/type_passive_damage_mods.asm:44`); `TypePassive_TryDarkStatusShield_Far` (13:4a78, `engine/battle/type_passive_damage_mods.asm:1058`); `TypePassive_MaybePoisonRetaliation_Far` (13:4ad9, `engine/battle/type_passive_damage_mods.asm:1131`); `ApplyLateGenDamageMultipliers_Far` (13:40c5, `engine/battle/late_gen_held_items.asm:177`); `HandleLateGenAfterHitEffects_Far` (13:4166, `engine/battle/late_gen_held_items.asm:286`); `TryActivateDittoImposter` (01:7ae1, `engine/battle/ditto_imposter.asm:1`)
...
- Anchors: `Moves` (10:5aaa, `data/moves/moves.asm:34`); `MoveEffects` (09:7489, `data/moves/effects.asm:3`); `MoveContactFlags` (13:4c6b, `data/moves/contact_flags.asm:4`); `Spikes` (09:79a7, `data/moves/effects.asm:1529`); `RapidSpin` (09:7a7c, `data/moves/effects.asm:1776`)
...
- Anchors: `ItemAttributes` (01:68c1, `data/items/attributes.asm:8`); `ItemDescriptions` (6e:4000, `data/items/descriptions.asm:1`); `ItemNames` (6c:4000, `data/items/names.asm:1`); `IsChoiceHeldEffect_Far` (13:4462, `engine/battle/late_gen_held_items.asm:808`); `IsMoveBlockedByAssaultVest_Far` (13:446f, `engine/battle/late_gen_held_items.asm:820`)
...
- Anchors: `BaseData` (14:5ac4, `data/pokemon/base_stats.asm:21`); `EvosAttacksPointers` (10:685c, `data/pokemon/evos_attacks_pointers.asm:3`); `EggMovePointers` (08:79f0, `data/pokemon/egg_move_pointers.asm:1`)
...
- Anchors: `wBattleMode` (01:d116, `ram/wram.asm:2008`); `wEnemyMon` (01:d0ef, `ram/wram.asm:2001`); `wBattleMon` (00:cafc, `ram/wram.asm:661`); `hROMBank` (00:ff9f, `ram/hram.asm:26`)
...
- Anchors: `PokemonPicPointers` (12:4000, `data/pokemon/pic_pointers.asm:3`); `TrainerPicPointers` (20:4000, `data/trainers/pic_pointers.asm:3`); `Tilesets` (05:5b94, `data/tilesets.asm:13`)
...
| `bankB` | ROMX | 0b:4000-4aca | 2763 | ROMX 0b | `engine/battle/ai/redundant.asm`, `engine/battle/trainer_huds.asm`, `engine/events/move_deleter.asm`, `engine/events/move_reminder.asm`, +5 more |
| `Effect Commands` | ROMX | 0d:4000-7f8e | 16271 | ROMX 0d | `engine/battle/effect_commands.asm`, `engine/battle/used_move_text.asm`, `main.asm` |
| `Enemy Trainers` | ROMX | 0e:4000-7e92 | 16019 | ROMX 0e | `engine/battle/ai/boss_platform.asm`, `engine/battle/ai/boss_policy_move.asm`, `engine/battle/ai/boss_policy_switch.asm`, `engine/battle/ai/boss_thunks.asm`, +6 more |
...
| `Late Gen Held Items` | ROMX | 13:4000-4d68 | 3433 |  | `engine/battle/late_gen_held_items.asm`, `engine/battle/type_passive_damage_mods.asm`, `main.asm` |
...
| `Events` | ROMX | 25:65f9-7dc6 | 6094 | ROMX 25 | `data/wild/bug_contest_mons.asm`, `engine/events/trainer_scripts.asm`, `engine/overworld/cmd_queue.asm`, `engine/overworld/events.asm`, +1 more |
...
| `Standard Scripts` | ROMX | 40:4000-63d8 | 9177 | ROMX 40 | `data/text/battle.asm`, `data/text/boss_ai_haki_taunts.asm`, `engine/events/std_scripts.asm`, `main.asm` |
...
| `Map Scripts 8` | ROMX | 49:4000-5ed1 | 7890 | ROMX 49 | `data/maps/scripts.asm`, `maps/BlackthornCity.asm`, `maps/EcruteakCity.asm`, `maps/LakeOfRage.asm`, +3 more |
...
| `Map Scripts 16` | ROMX | 51:4000-5dee | 7663 | ROMX 51 | `data/maps/scripts.asm`, `maps/MahoganyGym.asm`, `maps/MahoganyPokecenter1F.asm`, `maps/MahoganyRedGyaradosSpeechHouse.asm`, +12 more |
...
| `Map Scripts 18` | ROMX | 53:4000-5ddd | 7646 | ROMX 53 | `data/maps/scripts.asm`, `maps/BlackthornDragonSpeechHouse.asm`, `maps/BlackthornEmysHouse.asm`, `maps/BlackthornGym1F.asm`, +12 more |
...
| `Map Scripts 32` | ROMX | 62:4000-4eb6 | 3767 | ROMX 62 | `data/maps/scripts.asm`, `maps/CherrygroveEvolutionSpeechHouse.asm`, `maps/CherrygroveGymSpeechHouse.asm`, `maps/CherrygroveMart.asm`, +5 more |

## Important Labels

| Label | Address | Source |
| --- | --- | --- |
| `BossAI_IncrementTurnsElapsed` | 0e:4183 | `engine/battle/ai/boss_platform.asm:24` |
| `BossAI_RecordPlayerSwitch` | 0e:4231 | `engine/battle/ai/boss_platform.asm:165` |
| `BossAI_SelectMove` | 0e:54cb | `engine/battle/ai/boss_policy_move.asm:2827` |
| `BossAI_TrySwitch` | 0e:567a | `engine/battle/ai/boss_policy_switch.asm:17` |
| `BossAI_ComputeSwitchConfidence` | 0e:63d7 | `engine/battle/ai/boss_policy_switch.asm:1031` |
| `BossAI_PredictPlayerSwitch` | 0e:6446 | `engine/battle/ai/boss_policy_move.asm:4109` |
| `BossAI_RecordRevealedPlayerMove` | 0e:4384 | `engine/battle/ai/boss_platform.asm:315` |
| `BossAI_CurrentEnemyMoveHasKOPressure` | 0e:5e53 | `engine/battle/ai/boss_policy_move.asm:3300` |
| `BossAI_CurrentEnemyMovePressureScore` | 0e:5e64 | `engine/battle/ai/boss_policy_move.asm:3312` |
| `BossAI_PlayerHasPublicThreatVsEnemy` | 0e:5cc1 | `engine/battle/ai/boss_policy_move.asm:3163` |
| `BossAI_PublicEnemyFaster` | 0e:6226 | `engine/battle/ai/boss_policy_move.asm:4015` |
| `BossAI_CheckAbleToSwitchSafe` | 0e:594e | `engine/battle/ai/boss_policy_switch.asm:561` |
| `BossAI_RefineSwitchCandidateForPlausibleRisk` | 0e:72b1 | `engine/battle/ai/boss_policy_switch.asm:1107` |
| `BossAI_ApplyPlausibleRiskToSwitchConfidence` | 0e:74d6 | `engine/battle/ai/boss_policy_switch.asm:1479` |
| `BossAITierMap` | 0e:7dcd | `data/trainers/ai_tiers.asm:1` |
| `CheckPlayerMoveTypeMatchups` | 0d:49e5 | `engine/battle/ai/switch.asm:1` |
| `AICompareSpeed` | 11:72fc | `engine/battle/ai/scoring.asm:2654` |
| `AIDamageCalc` | 11:74b1 | `engine/battle/ai/scoring.asm:2982` |
| `TypePassive_ApplyDamageModifiers_Far` | 13:4523 | `engine/battle/type_passive_damage_mods.asm:44` |
| `TypePassive_TryDarkStatusShield_Far` | 13:4a78 | `engine/battle/type_passive_damage_mods.asm:1058` |
| `TypePassive_MaybePoisonRetaliation_Far` | 13:4ad9 | `engine/battle/type_passive_damage_mods.asm:1131` |
...
| `MoveContactFlags` | 13:4c6b | `data/moves/contact_flags.asm:4` |
...
| `IsChoiceHeldEffect_Far` | 13:4462 | `engine/battle/late_gen_held_items.asm:808` |
| `IsMoveBlockedByAssaultVest_Far` | 13:446f | `engine/battle/late_gen_held_items.asm:820` |
| `BaseData` | 14:5ac4 | `data/pokemon/base_stats.asm:21` |
...
| `wBattleMode` | 01:d116 | `ram/wram.asm:2008` |
| `wEnemyMon` | 01:d0ef | `ram/wram.asm:2001` |
...
| `Tilesets` | 05:5b94 | `data/tilesets.asm:13` |
