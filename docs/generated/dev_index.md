...
- Anchors: `BossAI_IncrementTurnsElapsed` (0e:417a, `engine/battle/ai/boss_platform.asm:24`); `BossAI_RecordPlayerSwitch` (0e:4228, `engine/battle/ai/boss_platform.asm:165`); `BossAI_SelectMove` (0e:544a, `engine/battle/ai/boss_policy_move.asm:2755`); `BossAI_TrySwitch` (0e:55f9, `engine/battle/ai/boss_policy_switch.asm:17`); `BossAI_ComputeSwitchConfidence` (0e:635f, `engine/battle/ai/boss_policy_switch.asm:1037`); `BossAI_PredictPlayerSwitch` (0e:63ce, `engine/battle/ai/boss_policy_move.asm:4037`); `BossAI_RecordRevealedPlayerMove` (0e:437b, `engine/battle/ai/boss_platform.asm:315`); `BossAI_CurrentEnemyMoveHasKOPressure` (0e:5dd9, `engine/battle/ai/boss_policy_move.asm:3228`); `BossAI_CurrentEnemyMovePressureScore` (0e:5dea, `engine/battle/ai/boss_policy_move.asm:3240`); `BossAI_PlayerHasPublicThreatVsEnemy` (0e:5c47, `engine/battle/ai/boss_policy_move.asm:3091`); `BossAI_PublicEnemyFaster` (0e:61ac, `engine/battle/ai/boss_policy_move.asm:3943`); `BossAI_CheckAbleToSwitchSafe` (0e:58cd, `engine/battle/ai/boss_policy_switch.asm:561`); `BossAI_RefineSwitchCandidateForPlausibleRisk` (0e:7239, `engine/battle/ai/boss_policy_switch.asm:1113`); `BossAI_ApplyPlausibleRiskToSwitchConfidence` (0e:745e, `engine/battle/ai/boss_policy_switch.asm:1485`)
...
| `Enemy Trainers` | ROMX | 0e:4000-7e0b | 15884 | ROMX 0e | `engine/battle/ai/boss_platform.asm`, `engine/battle/ai/boss_policy_move.asm`, `engine/battle/ai/boss_policy_switch.asm`, `engine/battle/ai/boss_thunks.asm`, +6 more |
...
| `BossAI_ComputeSwitchConfidence` | 0e:635f | `engine/battle/ai/boss_policy_switch.asm:1037` |
| `BossAI_PredictPlayerSwitch` | 0e:63ce | `engine/battle/ai/boss_policy_move.asm:4037` |
| `BossAI_RecordRevealedPlayerMove` | 0e:437b | `engine/battle/ai/boss_platform.asm:315` |
| `BossAI_CurrentEnemyMoveHasKOPressure` | 0e:5dd9 | `engine/battle/ai/boss_policy_move.asm:3228` |
| `BossAI_CurrentEnemyMovePressureScore` | 0e:5dea | `engine/battle/ai/boss_policy_move.asm:3240` |
| `BossAI_PlayerHasPublicThreatVsEnemy` | 0e:5c47 | `engine/battle/ai/boss_policy_move.asm:3091` |
| `BossAI_PublicEnemyFaster` | 0e:61ac | `engine/battle/ai/boss_policy_move.asm:3943` |
| `BossAI_CheckAbleToSwitchSafe` | 0e:58cd | `engine/battle/ai/boss_policy_switch.asm:561` |
| `BossAI_RefineSwitchCandidateForPlausibleRisk` | 0e:7239 | `engine/battle/ai/boss_policy_switch.asm:1113` |
| `BossAI_ApplyPlausibleRiskToSwitchConfidence` | 0e:745e | `engine/battle/ai/boss_policy_switch.asm:1485` |
| `BossAITierMap` | 0e:7d46 | `data/trainers/ai_tiers.asm:1` |
| `CheckPlayerMoveTypeMatchups` | 0d:49e5 | `engine/battle/ai/switch.asm:1` |
| `AICompareSpeed` | 11:7316 | `engine/battle/ai/scoring.asm:2658` |
| `AIDamageCalc` | 11:74cb | `engine/battle/ai/scoring.asm:2986` |
