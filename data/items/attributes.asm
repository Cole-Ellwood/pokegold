...
; MOON_STONE (removed 2026-05-24; stub slot)
...
; FIRE_STONE (removed 2026-05-24; stub slot)
	item_attribute 0, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; THUNDERSTONE (removed 2026-05-24; stub slot)
	item_attribute 0, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; WATER_STONE (removed 2026-05-24; stub slot)
	item_attribute 0, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ITEM_19
	item_attribute $9999, HELD_NONE, 0, NO_LIMITS, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; HP_UP
...
; IRON (now CURE-ALL): party-wide status cure, used in place (no mon select)
	item_attribute 1500, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_CURRENT, ITEMMENU_NOUSE
; CARBOS (now REPEL CUBE): top-tier repel, used in place
...
; CALCIUM (now SILVERNUGGET): no use; sells well; kept out of marts
...
; X_ACCURACY (removed 2026-05-24; stub slot)
	item_attribute 0, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; LEAF_STONE (removed 2026-05-24; stub slot)
	item_attribute 0, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; METAL_POWDER
...
; GUARD_SPEC (removed 2026-05-24; stub slot)
	item_attribute 0, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SUPER_REPEL
...
; DIRE_HIT (removed 2026-05-24; stub slot)
	item_attribute 0, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ITEM_2D
	item_attribute $9999, HELD_NONE, 0, NO_LIMITS, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; FRESH_WATER
...
; X_ATTACK (removed 2026-05-24; stub slot)
	item_attribute 0, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ITEM_32
	item_attribute $9999, HELD_NONE, 0, NO_LIMITS, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; X_DEFEND (removed 2026-05-24; stub slot)
	item_attribute 0, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; X_SPEED (removed 2026-05-24; stub slot)
	item_attribute 0, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; X_SPECIAL (removed 2026-05-24; stub slot)
	item_attribute 0, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; COIN_CASE
...
; EXPERT_BELT
	item_attribute 3000, HELD_EXPERT_BELT, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; MUSCLE_BAND
	item_attribute 3000, HELD_MUSCLE_BAND, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; METAL_COAT
...
; WISE_GLASSES
	item_attribute 3000, HELD_WISE_GLASSES, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; LEFTOVERS
	item_attribute 200, HELD_LEFTOVERS, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; EVOLITE
	item_attribute 3000, HELD_EVOLITE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; AIR_BALLOON
	item_attribute 800, HELD_AIR_BALLOON, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SHELL_BELL
	item_attribute 2000, HELD_SHELL_BELL, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; MYSTERYBERRY
...
; METRONOME_ITEM
	item_attribute 3000, HELD_METRONOME, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; WHIRL_KIT
	item_attribute 0, HELD_NONE, 0, CANT_TOSS, KEY_ITEM, ITEMMENU_CLOSE, ITEMMENU_NOUSE
; SACRED_ASH
...
; GORGEOUS_BOX
	item_attribute 10, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_CURRENT, ITEMMENU_NOUSE
; SUN_STONE (removed 2026-05-24; stub slot)
	item_attribute 0, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; POLKADOT_BOW
	item_attribute 100, HELD_NORMAL_BOOST, 20, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; LANTERN
...
; TM51 (CUT)
	item_attribute 0, HELD_NONE, 0, CANT_SELECT, TM_HM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; TM52 (FLY)
	item_attribute 0, HELD_NONE, 0, CANT_SELECT, TM_HM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; TM53 (SURF)
	item_attribute 0, HELD_NONE, 0, CANT_SELECT, TM_HM, ITEMMENU_PARTY, ITEMMENU_NOUSE
