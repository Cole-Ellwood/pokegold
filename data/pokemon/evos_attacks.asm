...
GloomEvosAttacks:
	db EVOLVE_LEVEL, 35, VILEPLUME
	db EVOLVE_LEVEL, 35, BELLOSSOM
	db 0 ; no more evolutions
	db 1, ABSORB
	db 1, SWEET_SCENT
	db 1, POISONPOWDER
...
EeveeEvosAttacks:
	...
	db EVOLVE_LEVEL, 32, VAPOREON
	db EVOLVE_LEVEL, 32, FLAREON
	db EVOLVE_LEVEL, 32, ESPEON
	db EVOLVE_LEVEL, 32, UMBREON
	db 0 ; no more evolutions
	db 1, TACKLE
	db 1, TAIL_WHIP
	db 8, SAND_ATTACK
