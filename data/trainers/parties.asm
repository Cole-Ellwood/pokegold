...
ChampionGroup:
	...
	db 46, STEELIX,    METAL_COAT, EARTHQUAKE, IRON_TAIL, OUTRAGE, ROAR
	db 49, GYARADOS,   LEFTOVERS, RAIN_DANCE, OUTRAGE, SURF, HYPER_BEAM
	db 47, AMPHAROS,   MAGNET, THUNDER, OUTRAGE, FIRE_PUNCH, THUNDER_WAVE
	db 46, YANMA,      FOCUS_BAND, QUIVER_DANCE, OUTRAGE, GIGA_DRAIN, SLEEP_POWDER
	db 49, KINGDRA,    LEFTOVERS, SURF, OUTRAGE, BLIZZARD, REST
