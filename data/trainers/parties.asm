...
Rival1Group:
	...
	db  8, CHIKORITA,  NO_ITEM, TACKLE, GROWL, RAZOR_LEAF, REFLECT
	db -1 ; end

	; RIVAL1 (2)
	db "?@", TRAINERTYPE_ITEM_MOVES
	db  8, CYNDAQUIL,  NO_ITEM, TACKLE, LEER, EMBER, SMOKESCREEN
	db -1 ; end

	; RIVAL1 (3)
	db "?@", TRAINERTYPE_ITEM_MOVES
	db  8, TOTODILE,   NO_ITEM, SCRATCH, LEER, WATER_GUN, RAGE
	db -1 ; end
	...
	; RIVAL1 (7)
	db "?@", TRAINERTYPE_ITEM_MOVES
	db 20, HAUNTER,    SPELL_TAG, HYPNOSIS, SHADOW_BALL, CURSE, CONFUSE_RAY
	...
	; RIVAL1 (10)
	db "?@", TRAINERTYPE_ITEM_MOVES
	db 29, SNEASEL,    BLACKGLASSES, FAINT_ATTACK, QUICK_ATTACK, FURY_CUTTER, SCREECH
	...
	db 27, HAUNTER,    SPELL_TAG, SHADOW_BALL, HYPNOSIS, CURSE, CONFUSE_RAY
