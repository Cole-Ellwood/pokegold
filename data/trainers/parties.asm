...
Rival1Group:
	...
	db 29, MEGANIUM,   MIRACLE_SEED, GIGA_DRAIN, BODY_SLAM, GROWTH, REFLECT
	db -1 ; end
	...
	db 25, MAGNEMITE,  MAGNET, THUNDERBOLT, THUNDER_WAVE, SONICBOOM, SWIFT
	db 27, HAUNTER,    SPELL_TAG, SHADOW_BALL, HYPNOSIS, DREAM_EATER, CONFUSE_RAY
	db 29, QUILAVA,    CHARCOAL, FLAME_WHEEL, THUNDERPUNCH, QUICK_ATTACK, SMOKESCREEN
	db -1 ; end
	...
	db 25, MAGNEMITE,  MAGNET, THUNDERBOLT, THUNDER_WAVE, SONICBOOM, SWIFT
	db 27, HAUNTER,    SPELL_TAG, SHADOW_BALL, HYPNOSIS, DREAM_EATER, CONFUSE_RAY
	db 29, FERALIGATR, MYSTIC_WATER, SURF, BITE, SLASH, SCARY_FACE
	db -1 ; end

	; RIVAL1 (13)
	db "?@", TRAINERTYPE_ITEM_MOVES
	db 32, SNEASEL,    LIFE_ORB, FAINT_ATTACK, SHADOW_BALL, QUICK_ATTACK, FURY_CUTTER
	db 34, CROBAT,     SHARP_BEAK, WING_ATTACK, BITE, CONFUSE_RAY, TOXIC
	db 33, MAGNETON,   AIR_BALLOON, THUNDERBOLT, THUNDER_WAVE, SWIFT, SONICBOOM
	db 33, GENGAR,     SPELL_TAG, SHADOW_BALL, HYPNOSIS, DESTINY_BOND, CONFUSE_RAY
	db 33, ALAKAZAM,   WISE_GLASSES, PSYCHIC_M, FIRE_PUNCH, ICE_PUNCH, THUNDERPUNCH
	db 36, MEGANIUM,   EXPERT_BELT, GIGA_DRAIN, BODY_SLAM, EARTHQUAKE, GROWTH
	db -1 ; end
	...
	db 33, GENGAR,     SPELL_TAG, SHADOW_BALL, HYPNOSIS, DESTINY_BOND, CONFUSE_RAY
	db 33, ALAKAZAM,   WISE_GLASSES, PSYCHIC_M, FIRE_PUNCH, ICE_PUNCH, THUNDERPUNCH
	db 36, TYPHLOSION, EXPERT_BELT, FIRE_BLAST, THUNDERPUNCH, ANCIENTPOWER, QUICK_ATTACK
	db -1 ; end
	...
	db 33, GENGAR,     SPELL_TAG, SHADOW_BALL, HYPNOSIS, DESTINY_BOND, CONFUSE_RAY
	db 33, ALAKAZAM,   WISE_GLASSES, PSYCHIC_M, FIRE_PUNCH, ICE_PUNCH, THUNDERPUNCH
	db 36, FERALIGATR, MUSCLE_BAND, SURF, CROSS_CHOP, SLASH, DRAGON_DANCE
	db -1 ; end
