...
Rival1Group:
	...
	db 38, MEGANIUM,   EXPERT_BELT, GIGA_DRAIN, BODY_SLAM, EARTHQUAKE, GROWTH
	db -1 ; end
	...
	db 33, GENGAR,     SPELL_TAG, SHADOW_BALL, SLUDGE_BOMB, PSYCHIC_M, THUNDER
	db 33, ALAKAZAM,   WISE_GLASSES, PSYCHIC_M, FIRE_PUNCH, ICE_PUNCH, THUNDERPUNCH
	db 38, TYPHLOSION, EXPERT_BELT, FIRE_BLAST, THUNDERPUNCH, ANCIENTPOWER, QUICK_ATTACK
	db -1 ; end
...
Rival2Group:
	; RIVAL2 (1)
	db "?@", TRAINERTYPE_ITEM_MOVES
	db 38, SNEASEL,    LIFE_ORB, FAINT_ATTACK, SHADOW_BALL, QUICK_ATTACK, FURY_CUTTER
	db 39, CROBAT,     CHOICE_BAND, WING_ATTACK, SLUDGE_BOMB, RETURN, BITE
	db 38, MAGNETON,   AIR_BALLOON, THUNDERBOLT, THUNDER, SWIFT, SONICBOOM
	...
	db 42, MEGANIUM,   EXPERT_BELT, GIGA_DRAIN, EARTHQUAKE, BODY_SLAM, GROWTH
	db -1 ; end
	...
	db 40, GENGAR,     SPELL_TAG, SHADOW_BALL, PSYCHIC_M, THUNDERBOLT, DESTINY_BOND
	db 40, ALAKAZAM,   WISE_GLASSES, PSYCHIC_M, FIRE_PUNCH, ICE_PUNCH, THUNDERPUNCH
	db 42, TYPHLOSION, EXPERT_BELT, FIRE_BLAST, THUNDERPUNCH, ANCIENTPOWER, QUICK_ATTACK
	db -1 ; end
	...
	; RIVAL2 (4)
	db "?@", TRAINERTYPE_ITEM_MOVES
	db 43, SNEASEL,    LIFE_ORB, FAINT_ATTACK, SHADOW_BALL, QUICK_ATTACK, FURY_CUTTER
	db 46, CROBAT,     CHOICE_BAND, WING_ATTACK, SLUDGE_BOMB, RETURN, BITE
	db 43, MAGNETON,   AIR_BALLOON, THUNDERBOLT, THUNDER, SWIFT, SONICBOOM
	...
	db 48, MEGANIUM,   EXPERT_BELT, GIGA_DRAIN, EARTHQUAKE, BODY_SLAM, GROWTH
	db -1 ; end
	...
	db 44, GENGAR,     LIFE_ORB, SHADOW_BALL, PSYCHIC_M, THUNDERBOLT, DESTINY_BOND
	db 44, ALAKAZAM,   CHOICE_SPECS, PSYCHIC_M, FIRE_PUNCH, ICE_PUNCH, THUNDERPUNCH
	db 48, TYPHLOSION, EXPERT_BELT, FIRE_BLAST, THUNDERPUNCH, ANCIENTPOWER, FLAMETHROWER
	db -1 ; end
