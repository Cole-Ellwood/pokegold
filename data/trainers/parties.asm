...
FalknerGroup:
	...
	db 12, PIDGEOTTO,  SHARP_BEAK, WING_ATTACK, MUD_SLAP, QUICK_ATTACK, WHIRLWIND
	db 13, NOCTOWL,    MINT_BERRY, HYPNOSIS, CONFUSION, REFLECT, PECK
	db 14, FEAROW,     SHARP_BEAK, WING_ATTACK, MUD_SLAP, TACKLE, AGILITY
	db -1 ; end

WhitneyGroup:
	; WHITNEY (1)
	db "WHITNEY@", TRAINERTYPE_ITEM_MOVES
	db 19, CLEFAIRY,   EVOLITE, ENCORE, THUNDER_WAVE, DOUBLE_TEAM, DOUBLESLAP
	db 20, GIRAFARIG,  TWISTEDSPOON, PSYBEAM, AGILITY, BATON_PASS, CRUNCH
...
BugsyGroup:
	...
	db 15, ARIADOS,    BERRY, POISON_STING, GIGA_DRAIN, TOXIC, STRING_SHOT
...
MortyGroup:
	...
	db 23, MISDREAVUS, LEFTOVERS, CONFUSE_RAY, TOXIC, PAIN_SPLIT, PSYCHIC_M
	db 26, GENGAR,     SPELL_TAG, SHADOW_BALL, THUNDERBOLT, DESTINY_BOND, SPIKES
	db 24, HAUNTER,    FOCUS_BAND, HYPNOSIS, SHADOW_BALL, HAZE, CONFUSE_RAY
	db -1 ; end
...
JasmineGroup:
	...
	db 31, MAGNETON,   MAGNET, SPIKES, THUNDERBOLT, THUNDER_WAVE, LIGHT_SCREEN
...
ClairGroup:
	...
	db 38, STEELIX,    METAL_COAT, EARTHQUAKE, IRON_TAIL, ROCK_SLIDE, ROAR
	db 37, DRAGONAIR,  MIRACLEBERRY, THUNDER_WAVE, SURF, DRAGONBREATH, OUTRAGE
	db -1 ; end
...
WillGroup:
	...
	db 40, STARMIE,    TWISTEDSPOON, RAPID_SPIN, SURF, PSYCHIC_M, THUNDERBOLT
	...
	db 43, XATU,       FOCUS_BAND, REFLECT, CONFUSE_RAY, FUTURE_SIGHT, DRILL_PECK
	db -1 ; end
...
BrunoGroup:
	...
	db 43, HITMONLEE,  FOCUS_BAND, MEDITATE, HI_JUMP_KICK, ROCK_SLIDE, FORESIGHT
	db 46, MACHAMP,    LEFTOVERS, CROSS_CHOP, EARTHQUAKE, ROCK_SLIDE, VITAL_THROW
	db 44, TYRANITAR,  BLACKGLASSES, CRUNCH, ROCK_SLIDE, EARTHQUAKE, PURSUIT
	db 44, HERACROSS,  SCOPE_LENS, MEGAHORN, REVERSAL, ROCK_SLIDE, PURSUIT
	db -1 ; end

KarenGroup:
	; KAREN (1)
	db "KAREN@", TRAINERTYPE_ITEM_MOVES
	db 42, GENGAR,     SPELL_TAG, SPIKES, SHADOW_BALL, HYPNOSIS, DESTINY_BOND
	db 42, DONPHAN,    SOFT_SAND, RAPID_SPIN, EARTHQUAKE, ROCK_SLIDE, ROAR
	db 44, MURKROW,    BLACKGLASSES, AGILITY, FAINT_ATTACK, PURSUIT, TOXIC
	db 46, TYRANITAR,  BLACKGLASSES, CRUNCH, ROCK_SLIDE, EARTHQUAKE, PURSUIT
	db 45, CROBAT,     LEFTOVERS, WING_ATTACK, CONFUSE_RAY, TOXIC, SAFEGUARD
	db 47, HOUNDOOM,   CHARCOAL, FLAMETHROWER, CRUNCH, SUNNY_DAY, ROAR
	db -1 ; end

KogaGroup:
	; KOGA (1)
	db "KOGA@", TRAINERTYPE_ITEM_MOVES
	db 40, ARIADOS,    LEFTOVERS, SPIKES, TOXIC, GIGA_DRAIN, SPIDER_WEB
	db 41, TENTACRUEL, MYSTIC_WATER, RAPID_SPIN, SURF, SLUDGE_BOMB, HAZE
	db 42, MUK,        LEFTOVERS, CURSE, SLUDGE_BOMB, TOXIC, REST
	db 43, NIDOKING,   SOFT_SAND, EARTHQUAKE, SLUDGE_BOMB, ICE_BEAM, THUNDERBOLT
	db 42, UMBREON,    MINT_BERRY, PURSUIT, CONFUSE_RAY, MOONLIGHT, TOXIC
	db 44, CROBAT,     SHARP_BEAK, WING_ATTACK, TOXIC, CONFUSE_RAY, HYPER_BEAM
	db -1 ; end

ChampionGroup:
	; CHAMPION (1)
	db "LANCE@", TRAINERTYPE_ITEM_MOVES
	db 44, GLIGAR,     QUICK_CLAW, SPIKES, EARTHQUAKE, WING_ATTACK, TOXIC
	db 45, STARMIE,    MYSTIC_WATER, RAPID_SPIN, SURF, THUNDERBOLT, ICE_BEAM
	db 50, DRAGONITE,  LEFTOVERS, DRAGON_DANCE, OUTRAGE, EARTHQUAKE, HYPER_BEAM
	db 46, AERODACTYL, SHARP_BEAK, ROCK_SLIDE, WING_ATTACK, EARTHQUAKE, SUBSTITUTE
	db 46, STEELIX,    METAL_COAT, EARTHQUAKE, IRON_TAIL, ROCK_SLIDE, ROAR
