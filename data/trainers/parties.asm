...
WillGroup:
	...
	db 42, XATU,       FOCUS_BAND, REFLECT, CONFUSE_RAY, FUTURE_SIGHT, DRILL_PECK
	db -1 ; end
...
ChampionGroup:
	...
	db 47, DRAGONITE,  LEFTOVERS, DRAGON_DANCE, OUTRAGE, EARTHQUAKE, FIRE_BLAST
	...
	db 50, GYARADOS,   LEFTOVERS, RAIN_DANCE, OUTRAGE, SURF, HYPER_BEAM
	db -1 ; end
...
BrockGroup:
	...
	db 58, GOLEM,      ROCKY_HELMET, CURSE, EARTHQUAKE, ROCK_SLIDE, EXPLOSION
	...
	db 60, AERODACTYL, HARD_STONE, EARTHQUAKE, ROCK_SLIDE, WING_ATTACK, ROAR
	db -1 ; end
...
MistyGroup:
	...
	db 59, STARMIE,    WISE_GLASSES, RAPID_SPIN, SURF, PSYCHIC_M, THUNDERBOLT
...
LtSurgeGroup:
	...
	db 59, RAICHU,     EXPERT_BELT, AGILITY, THUNDERBOLT, THUNDER_WAVE, QUICK_ATTACK
...
ErikaGroup:
	...
	db 61, VICTREEBEL, MUSCLE_BAND, SWORDS_DANCE, SLUDGE_BOMB, RAZOR_LEAF, SLEEP_POWDER
...
SabrinaGroup:
	...
	db 63, ALAKAZAM,   CHOICE_SPECS, PSYCHIC_M, ICE_PUNCH, THUNDERPUNCH, FIRE_PUNCH
...
BlaineGroup:
	...
	db 61, MAGCARGO,   ROCKY_HELMET, SPIKES, CURSE, FLAMETHROWER, ROCK_SLIDE
	db 62, NINETALES,  CHARCOAL, SUNNY_DAY, FIRE_BLAST, CONFUSE_RAY, SAFEGUARD
	db 63, RAPIDASH,   MUSCLE_BAND, AGILITY, FIRE_BLAST, QUICK_ATTACK, DOUBLE_EDGE
...
BlueGroup:
	...
	db 69, ARCANINE,   LIFE_ORB, FLAMETHROWER, EXTREMESPEED, CRUNCH, ROAR
	db -1 ; end
