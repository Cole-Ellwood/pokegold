...
FalknerGroup:
	...
	db 11, FEAROW,     SHARP_BEAK, PECK, MIRROR_MOVE, PURSUIT, AGILITY
	db -1 ; end

WhitneyGroup:
	; WHITNEY (1)
	db "WHITNEY@", TRAINERTYPE_ITEM_MOVES
	db 19, CLEFAIRY,   PINK_BOW, ENCORE, THUNDER_WAVE, DOUBLE_TEAM, DOUBLESLAP
...
BugsyGroup:
	...
	db 15, ARIADOS,    BERRY, POISON_STING, GIGA_DRAIN, BATON_PASS, STRING_SHOT
	db 15, PINECO,     BERRY, PROTECT, RAPID_SPIN, TACKLE, SPIKES
	db 17, SCYTHER,    SILVERPOWDER, SWORDS_DANCE, FURY_CUTTER, QUICK_ATTACK, LEER
	db -1 ; end
...
MortyGroup:
	...
	db 24, HAUNTER,    FOCUS_BAND, MEAN_LOOK, SPITE, HAZE, LICK
	db -1 ; end
...
PryceGroup:
	...
	db 30, STARMIE,    TWISTEDSPOON, RAPID_SPIN, SURF, PSYCHIC_M, THUNDERBOLT
	db 31, SNEASEL,    BLACKGLASSES, AGILITY, SHADOW_BALL, RETURN, QUICK_ATTACK
...
JasmineGroup:
	...
	db 31, MAGNETON,   MAGNET, SPIKES, THUNDERBOLT, THUNDER_WAVE, SUPERSONIC
	db 32, FORRETRESS, LEFTOVERS, RAPID_SPIN, TOXIC, PROTECT, EXPLOSION
	db 33, SCIZOR,     METAL_COAT, SWORDS_DANCE, METAL_CLAW, QUICK_ATTACK, WING_ATTACK
	db 34, STEELIX,    METAL_COAT, EARTHQUAKE, IRON_TAIL, ROCK_SLIDE, ROAR
	db 33, VAPOREON,   MYSTIC_WATER, SURF, ICE_BEAM, HAZE, ACID_ARMOR
	db -1 ; end

ChuckGroup:
	; CHUCK (1)
	db "CHUCK@", TRAINERTYPE_ITEM_MOVES
	db 28, ONIX,       SOFT_SAND, SPIKES, ROCK_SLIDE, EARTHQUAKE, ROAR
	db 29, HITMONTOP,  BLACKBELT_I, RAPID_SPIN, MACH_PUNCH, ROCK_SLIDE, DETECT
	db 31, HITMONLEE,  FOCUS_BAND, MEDITATE, HI_JUMP_KICK, ROCK_SLIDE, FORESIGHT
	db 30, UMBREON,    MINT_BERRY, PURSUIT, CONFUSE_RAY, MOONLIGHT, TOXIC
	db 32, POLIWRATH,  MYSTIC_WATER, DYNAMICPUNCH, SURF, ICE_PUNCH, HYPNOSIS
	db -1 ; end
...
ClairGroup:
	...
	db 37, DONPHAN,    SOFT_SAND, RAPID_SPIN, EARTHQUAKE, ROCK_SLIDE, ROAR
...
BrunoGroup:
	...
	db 42, HITMONTOP,  BLACKBELT_I, RAPID_SPIN, MACH_PUNCH, ROCK_SLIDE, DETECT
...
BrockGroup:
	...
	db 57, DONPHAN,    SOFT_SAND, RAPID_SPIN, EARTHQUAKE, ROCK_SLIDE, ROAR
	...
	db 59, VAPOREON,   SHELL_BELL, SURF, ICE_BEAM, HAZE, ACID_ARMOR
	db 60, ONIX,       SOFT_SAND, EARTHQUAKE, ROCK_SLIDE, IRON_TAIL, ROAR
	db -1 ; end

MistyGroup:
	; MISTY (1)
	db "MISTY@", TRAINERTYPE_ITEM_MOVES
	db 58, CLOYSTER,   NEVERMELTICE, SPIKES, SURF, ICE_BEAM, EXPLOSION
	...
	db 62, KINGDRA,    EXPERT_BELT, AGILITY, SURF, OUTRAGE, ICE_BEAM
	db -1 ; end

LtSurgeGroup:
	; LT_SURGE (1)
	db "LT.SURGE@", TRAINERTYPE_ITEM_MOVES
	db 58, MAGNETON,   AIR_BALLOON, SPIKES, THUNDERBOLT, THUNDER_WAVE, SUPERSONIC
	db 58, DONPHAN,    SOFT_SAND, RAPID_SPIN, EARTHQUAKE, ROCK_SLIDE, ROAR
	...
	db 61, EXEGGUTOR,  MIRACLE_SEED, SLEEP_POWDER, GIGA_DRAIN, PSYCHIC_M, EXPLOSION
	db -1 ; end
...
ErikaGroup:
	...
	db 57, FORRETRESS, ROCKY_HELMET, SPIKES, PROTECT, TOXIC, EXPLOSION
	db 58, STARMIE,    WISE_GLASSES, RAPID_SPIN, SURF, PSYCHIC_M, ICE_BEAM
...
JanineGroup:
	...
	db 60, ARIADOS,    LEFTOVERS, SPIKES, TOXIC, GIGA_DRAIN, SPIDER_WEB
...
SabrinaGroup:
	...
	db 61, FORRETRESS, ROCKY_HELMET, SPIKES, PROTECT, TOXIC, EXPLOSION
	db 61, STARMIE,    WISE_GLASSES, RAPID_SPIN, SURF, PSYCHIC_M, THUNDERBOLT
	db 62, ESPEON,     SHELL_BELL, AGILITY, PSYCHIC_M, MORNING_SUN, BATON_PASS
	db 63, ALAKAZAM,   CHOICE_SPECS, PSYCHIC_M, ICE_PUNCH, THUNDERPUNCH, FIRE_PUNCH
	db 63, HOUNDOOM,   LIFE_ORB, CRUNCH, FLAMETHROWER, SUNNY_DAY, PURSUIT
	db -1 ; end
...
BlaineGroup:
	...
	db 62, STARMIE,    WISE_GLASSES, RAPID_SPIN, SURF, THUNDERBOLT, ICE_BEAM
	...
	db 65, EXEGGUTOR,  MIRACLE_SEED, SLEEP_POWDER, GIGA_DRAIN, PSYCHIC_M, EXPLOSION
	db -1 ; end
...
BlueGroup:
	...
	db 65, PIDGEOT,    CHOICE_BAND, WING_ATTACK, RETURN, STEEL_WING, QUICK_ATTACK
	db 65, STARMIE,    WISE_GLASSES, RAPID_SPIN, SURF, THUNDERBOLT, ICE_BEAM
	...
	db 69, EXEGGUTOR,  MIRACLE_SEED, SLEEP_POWDER, GIGA_DRAIN, PSYCHIC_M, EXPLOSION
