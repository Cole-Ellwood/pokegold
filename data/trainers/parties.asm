...
FalknerGroup:
	...
	db 13, SPEAROW,    SHARP_BEAK, PECK, FURY_ATTACK, NO_MOVE, NO_MOVE
...
MortyGroup:
	...
	db 24, HAUNTER,    MIRACLEBERRY, HYPNOSIS, DREAM_EATER, CURSE, NIGHT_SHADE
	db 25, MISDREAVUS, LEFTOVERS, CONFUSE_RAY, TOXIC, PAIN_SPLIT, SHADOW_BALL
	db 26, GENGAR,     SPELL_TAG, SHADOW_BALL, THUNDERBOLT, DESTINY_BOND, PSYCHIC_M
	db 24, HAUNTER,    FOCUS_BAND, THUNDERBOLT, SHADOW_BALL, PSYBEAM, ICE_PUNCH
	db -1 ; end
...
Rival1Group:
	...
	; RIVAL1 (4)
	db "?@", TRAINERTYPE_ITEM_MOVES
	db 11, GASTLY,     NO_ITEM, LICK, CONFUSION, HYPNOSIS, MEAN_LOOK
	...
	; RIVAL1 (13)
	db "?@", TRAINERTYPE_ITEM_MOVES
	db 33, SNEASEL,    LIFE_ORB, FAINT_ATTACK, SHADOW_BALL, QUICK_ATTACK, ICE_PUNCH
	db 35, CROBAT,     SHARP_BEAK, WING_ATTACK, BITE, CONFUSE_RAY, TOXIC
	db 34, MAGNETON,   AIR_BALLOON, THUNDERBOLT, THUNDER_WAVE, HIDDEN_POWER, DRAGONBREATH
	db 34, GENGAR,     SPELL_TAG, SHADOW_BALL, SLUDGE_BOMB, PSYCHIC_M, THUNDER
	db 34, ALAKAZAM,   WISE_GLASSES, PSYCHIC_M, FIRE_PUNCH, ICE_PUNCH, THUNDERPUNCH
	db 39, MEGANIUM,   EXPERT_BELT, GIGA_DRAIN, BODY_SLAM, SYNTHESIS, GROWTH
	db -1 ; end
	...
	db 34, GENGAR,     SPELL_TAG, SHADOW_BALL, SLUDGE_BOMB, PSYCHIC_M, THUNDER
	db 34, ALAKAZAM,   WISE_GLASSES, PSYCHIC_M, FIRE_PUNCH, ICE_PUNCH, THUNDERPUNCH
	db 39, TYPHLOSION, EXPERT_BELT, FIRE_BLAST, THUNDERPUNCH, ANCIENTPOWER, DOUBLE_EDGE
	db -1 ; end
	...
	db 34, GENGAR,     SPELL_TAG, SHADOW_BALL, SLUDGE_BOMB, PSYCHIC_M, THUNDER
	db 34, ALAKAZAM,   WISE_GLASSES, PSYCHIC_M, FIRE_PUNCH, ICE_PUNCH, THUNDERPUNCH
	db 39, FERALIGATR, MUSCLE_BAND, SURF, CROSS_CHOP, SLASH, DRAGON_DANCE
	db -1 ; end
