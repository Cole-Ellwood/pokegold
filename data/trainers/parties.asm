...
FalknerGroup:
	...
	db  9, PIDGEOTTO,  SHARP_BEAK, WING_ATTACK, MUD_SLAP, QUICK_ATTACK, WHIRLWIND
	db 10, NOCTOWL,    MINT_BERRY, HYPNOSIS, CONFUSION, REFLECT, PECK
	db 11, FEAROW,     SHARP_BEAK, WING_ATTACK, MUD_SLAP, PURSUIT, AGILITY
	db -1 ; end
...
PryceGroup:
	...
	db 29, CLOYSTER,   NEVERMELTICE, SPIKES, SURF, ICE_BEAM, EXPLOSION
	db 30, DEWGONG,    NEVERMELTICE, RAPID_SPIN, SURF, ICE_BEAM, ENCORE
	db 31, SNEASEL,    BLACKGLASSES, FAINT_ATTACK, ICE_PUNCH, SHADOW_BALL, QUICK_ATTACK
	db 33, PILOSWINE,  SOFT_SAND, EARTHQUAKE, BLIZZARD, ROCK_SLIDE, ROAR
	db 32, SLOWKING,   LEFTOVERS, SURF, PSYCHIC_M, THUNDER_WAVE, REST
	db -1 ; end
...
ChuckGroup:
	...
	db 28, SUDOWOODO,  HARD_STONE, SPIKES, ROCK_SLIDE, FOCUS_PUNCH, ROAR
	db 29, HITMONTOP,  BLACKBELT_I, RAPID_SPIN, MACH_PUNCH, ROCK_SLIDE, FOCUS_PUNCH
	db 31, HITMONLEE,  FOCUS_BAND, FOCUS_PUNCH, HI_JUMP_KICK, ROCK_SLIDE, FORESIGHT
	db 30, UMBREON,    MINT_BERRY, PURSUIT, CONFUSE_RAY, MOONLIGHT, TOXIC
	db 32, POLIWRATH,  MYSTIC_WATER, FOCUS_PUNCH, SURF, ICE_PUNCH, HYPNOSIS
	db -1 ; end
