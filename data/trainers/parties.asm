...
KarenGroup:
	...
	db 45, CROBAT,     LEFTOVERS, WING_ATTACK, CONFUSE_RAY, TOXIC, WHIRLWIND
...
ChampionGroup:
	...
	db 46, AERODACTYL, SHARP_BEAK, ROCK_SLIDE, WING_ATTACK, EARTHQUAKE, ANCIENTPOWER
...
JanineGroup:
	...
	db 62, MUK,        ROCKY_HELMET, CURSE, SLUDGE_BOMB, TOXIC, REST
...
RedGroup:
	...
	db 75, SNORLAX,    LEFTOVERS, AMNESIA, SNORE, REST, BODY_SLAM
