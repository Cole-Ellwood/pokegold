...
BrockGroup:
	...
	db 59, SUDOWOODO,  HARD_STONE, SPIKES, ROCK_SLIDE, EARTHQUAKE, ROAR
	db 58, AERODACTYL, HARD_STONE, EARTHQUAKE, ROCK_SLIDE, WING_ATTACK, ROAR
	db -1 ; end
...
MistyGroup:
	...
	db 63, STARMIE,    WISE_GLASSES, RECOVER, HYDRO_PUMP, PSYCHIC_M, THUNDERBOLT
	db 60, QUAGSIRE,   SOFT_SAND, CURSE, EARTHQUAKE, SURF, REST
	db 61, LAPRAS,     LEFTOVERS, RAIN_DANCE, SURF, ICE_BEAM, THUNDERBOLT
	db 62, LANTURN,    MAGNET, THUNDER_WAVE, SURF, THUNDERBOLT, ICE_BEAM
	db -1 ; end
...
LtSurgeGroup:
	...
	db 60, ELECTABUZZ, WISE_GLASSES, THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH, LIGHT_SCREEN
...
ErikaGroup:
	...
	db 58, JUMPLUFF,   MIRACLEBERRY, SLEEP_POWDER, LEECH_SEED, ENCORE, GIGA_DRAIN
	db 59, BELLOSSOM,  LEFTOVERS, GROWTH, SUNNY_DAY, SYNTHESIS, SOLARBEAM
...
JanineGroup:
	...
	db 64, VENOMOTH,   WISE_GLASSES, SLEEP_POWDER, PSYCHIC_M, GIGA_DRAIN, SLUDGE_BOMB
	db -1 ; end
...
SabrinaGroup:
	...
	db 62, ESPEON,     TWISTEDSPOON, AGILITY, PSYCHIC_M, MORNING_SUN, BATON_PASS
	db 67, ALAKAZAM,   CHOICE_SPECS, PSYCHIC_M, ICE_PUNCH, THUNDERPUNCH, FIRE_PUNCH
	db 63, HYPNO,      LEFTOVERS, HYPNOSIS, DREAM_EATER, THUNDER_WAVE, PSYCHIC_M
	db -1 ; end
...
BlaineGroup:
	...
	db 64, NINETALES,  CHARCOAL, SUNNY_DAY, FIRE_BLAST, CONFUSE_RAY, SAFEGUARD
	db 64, RAPIDASH,   MUSCLE_BAND, AGILITY, FIRE_BLAST, QUICK_ATTACK, DOUBLE_EDGE
	db 64, ARCANINE,   LIFE_ORB, FLAMETHROWER, EXTREMESPEED, CRUNCH, ROAR
	db 65, MAGMAR,     WISE_GLASSES, FIRE_BLAST, THUNDERPUNCH, PSYCHIC_M, CONFUSE_RAY
	db -1 ; end
