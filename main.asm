...
DEF BOSSAI_EMIT_PLATFORM_TURN_CACHE_RESET EQU 1
INCLUDE "engine/battle/ai/boss_platform.asm"
PURGE BOSSAI_EMIT_PLATFORM_TURN_CACHE_RESET
DEF BOSSAI_EMIT_MOVE_APPLY_MODEL EQU 1
INCLUDE "engine/battle/ai/boss_policy_move.asm"
PURGE BOSSAI_EMIT_MOVE_APPLY_MODEL
DEF BOSSAI_EMIT_MOVE_GHOST_HELPER EQU 1
INCLUDE "engine/battle/ai/boss_policy_move.asm"
PURGE BOSSAI_EMIT_MOVE_GHOST_HELPER
DEF BOSSAI_EMIT_MOVE_SELECT EQU 1
INCLUDE "engine/battle/ai/boss_policy_move.asm"
PURGE BOSSAI_EMIT_MOVE_SELECT
DEF BOSSAI_EMIT_SWITCH_DISPATCH EQU 1
INCLUDE "engine/battle/ai/boss_policy_switch.asm"
PURGE BOSSAI_EMIT_SWITCH_DISPATCH
DEF BOSSAI_EMIT_HAKI_TAUNT_QUEUE EQU 1
INCLUDE "engine/battle/ai/haki_taunt_queue.asm"
PURGE BOSSAI_EMIT_HAKI_TAUNT_QUEUE
DEF BOSSAI_EMIT_OBSERVATION_LOG EQU 1
INCLUDE "engine/battle/ai/observation_log.asm"
PURGE BOSSAI_EMIT_OBSERVATION_LOG
DEF BOSSAI_EMIT_MOVE_ACTIVE_THREAT_CACHES EQU 1
INCLUDE "engine/battle/ai/boss_policy_move.asm"
PURGE BOSSAI_EMIT_MOVE_ACTIVE_THREAT_CACHES
DEF BOSSAI_EMIT_PLATFORM_TYPE_MATCHUP_NO_ITEM EQU 1
INCLUDE "engine/battle/ai/boss_platform.asm"
PURGE BOSSAI_EMIT_PLATFORM_TYPE_MATCHUP_NO_ITEM
DEF BOSSAI_EMIT_MOVE_PRESSURE_SCORING EQU 1
INCLUDE "engine/battle/ai/boss_policy_move.asm"
PURGE BOSSAI_EMIT_MOVE_PRESSURE_SCORING
DEF BOSSAI_EMIT_PLATFORM_MOVE_CATEGORY_WRAPPER EQU 1
INCLUDE "engine/battle/ai/boss_platform.asm"
PURGE BOSSAI_EMIT_PLATFORM_MOVE_CATEGORY_WRAPPER
DEF BOSSAI_EMIT_MOVE_ACCURACY_RISK EQU 1
INCLUDE "engine/battle/ai/boss_policy_move.asm"
PURGE BOSSAI_EMIT_MOVE_ACCURACY_RISK
DEF BOSSAI_EMIT_PLATFORM_DARK_SHIELD_AND_TYPES EQU 1
INCLUDE "engine/battle/ai/boss_platform.asm"
PURGE BOSSAI_EMIT_PLATFORM_DARK_SHIELD_AND_TYPES
DEF BOSSAI_EMIT_MOVE_PUBLIC_FASTER EQU 1
INCLUDE "engine/battle/ai/boss_policy_move.asm"
PURGE BOSSAI_EMIT_MOVE_PUBLIC_FASTER
DEF BOSSAI_EMIT_SWITCH_THRESHOLD_AND_LOOP EQU 1
INCLUDE "engine/battle/ai/boss_policy_switch.asm"
PURGE BOSSAI_EMIT_SWITCH_THRESHOLD_AND_LOOP
DEF BOSSAI_EMIT_SWITCH_REASON_PREDICATES EQU 1
INCLUDE "engine/battle/ai/boss_policy_switch.asm"
PURGE BOSSAI_EMIT_SWITCH_REASON_PREDICATES
DEF BOSSAI_EMIT_SWITCH_IN_CLASSIFIERS EQU 1
INCLUDE "engine/battle/ai/boss_policy_switch.asm"
PURGE BOSSAI_EMIT_SWITCH_IN_CLASSIFIERS
DEF BOSSAI_EMIT_SWITCH_ACE_AND_CONFIDENCE EQU 1
INCLUDE "engine/battle/ai/boss_policy_switch.asm"
PURGE BOSSAI_EMIT_SWITCH_ACE_AND_CONFIDENCE
DEF BOSSAI_EMIT_MOVE_PREDICT_AND_REVEALED_SE EQU 1
INCLUDE "engine/battle/ai/boss_policy_move.asm"
PURGE BOSSAI_EMIT_MOVE_PREDICT_AND_REVEALED_SE
DEF BOSSAI_EMIT_PLATFORM_PASSIVE_CACHES EQU 1
INCLUDE "engine/battle/ai/boss_platform.asm"
PURGE BOSSAI_EMIT_PLATFORM_PASSIVE_CACHES
DEF BOSSAI_EMIT_PLATFORM_HELD_ITEM_HELPERS EQU 1
INCLUDE "engine/battle/ai/boss_platform.asm"
PURGE BOSSAI_EMIT_PLATFORM_HELD_ITEM_HELPERS
DEF BOSSAI_EMIT_MOVE_BENCH_THREAT_SCORE EQU 1
INCLUDE "engine/battle/ai/boss_policy_move.asm"
PURGE BOSSAI_EMIT_MOVE_BENCH_THREAT_SCORE
DEF BOSSAI_EMIT_MOVE_PLAN_SELECTION EQU 1
INCLUDE "engine/battle/ai/boss_policy_move.asm"
PURGE BOSSAI_EMIT_MOVE_PLAN_SELECTION
DEF BOSSAI_EMIT_MOVE_PARTY_BY_ROLE EQU 1
INCLUDE "engine/battle/ai/boss_policy_move.asm"
PURGE BOSSAI_EMIT_MOVE_PARTY_BY_ROLE
DEF BOSSAI_EMIT_MOVE_EFFECT_CLASSIFIERS EQU 1
INCLUDE "engine/battle/ai/boss_policy_move.asm"
PURGE BOSSAI_EMIT_MOVE_EFFECT_CLASSIFIERS
DEF BOSSAI_EMIT_PLATFORM_SEEN_SPECIES_INDEX EQU 1
INCLUDE "engine/battle/ai/boss_platform.asm"
PURGE BOSSAI_EMIT_PLATFORM_SEEN_SPECIES_INDEX
DEF BOSSAI_EMIT_MOVE_MASK_CONSTRUCTION_OPEN EQU 1
INCLUDE "engine/battle/ai/boss_policy_move.asm"
PURGE BOSSAI_EMIT_MOVE_MASK_CONSTRUCTION_OPEN
DEF BOSSAI_EMIT_PLATFORM_CLEAR_PLAUSIBLE_MASK EQU 1
INCLUDE "engine/battle/ai/boss_platform.asm"
PURGE BOSSAI_EMIT_PLATFORM_CLEAR_PLAUSIBLE_MASK
DEF BOSSAI_EMIT_MOVE_MASK_REVEALED_AND_MOVE_ADDS EQU 1
INCLUDE "engine/battle/ai/boss_policy_move.asm"
PURGE BOSSAI_EMIT_MOVE_MASK_REVEALED_AND_MOVE_ADDS
DEF BOSSAI_EMIT_PLATFORM_MASK_SET_BITS EQU 1
INCLUDE "engine/battle/ai/boss_platform.asm"
PURGE BOSSAI_EMIT_PLATFORM_MASK_SET_BITS
DEF BOSSAI_EMIT_MOVE_MASK_SPECIES_SOURCES EQU 1
INCLUDE "engine/battle/ai/boss_policy_move.asm"
PURGE BOSSAI_EMIT_MOVE_MASK_SPECIES_SOURCES
DEF BOSSAI_EMIT_PLATFORM_MASK_TEST_BITS EQU 1
INCLUDE "engine/battle/ai/boss_platform.asm"
PURGE BOSSAI_EMIT_PLATFORM_MASK_TEST_BITS
DEF BOSSAI_EMIT_MOVE_PLAN_MOVE_BIAS EQU 1
INCLUDE "engine/battle/ai/boss_policy_move.asm"
PURGE BOSSAI_EMIT_MOVE_PLAN_MOVE_BIAS
DEF BOSSAI_EMIT_MOVE_SCOUT_REPEAT_BIASES EQU 1
INCLUDE "engine/battle/ai/boss_policy_move.asm"
PURGE BOSSAI_EMIT_MOVE_SCOUT_REPEAT_BIASES
DEF BOSSAI_EMIT_PLATFORM_SCORE_IO EQU 1
INCLUDE "engine/battle/ai/boss_platform.asm"
PURGE BOSSAI_EMIT_PLATFORM_SCORE_IO
DEF BOSSAI_EMIT_MOVE_LOOKAHEAD_TOP_CANDIDATES EQU 1
INCLUDE "engine/battle/ai/boss_policy_move.asm"
PURGE BOSSAI_EMIT_MOVE_LOOKAHEAD_TOP_CANDIDATES
DEF BOSSAI_EMIT_MOVE_LOOKAHEAD_BODY EQU 1
INCLUDE "engine/battle/ai/boss_policy_move.asm"
PURGE BOSSAI_EMIT_MOVE_LOOKAHEAD_BODY
DEF BOSSAI_EMIT_MOVE_LOOKAHEAD_CLAMP EQU 1
INCLUDE "engine/battle/ai/boss_policy_move.asm"
PURGE BOSSAI_EMIT_MOVE_LOOKAHEAD_CLAMP
DEF BOSSAI_EMIT_MOVE_PRIMARY_THREAT_TYPE EQU 1
INCLUDE "engine/battle/ai/boss_policy_move.asm"
PURGE BOSSAI_EMIT_MOVE_PRIMARY_THREAT_TYPE
DEF BOSSAI_EMIT_MOVE_THREAT_SEVERITY EQU 1
INCLUDE "engine/battle/ai/boss_policy_move.asm"
PURGE BOSSAI_EMIT_MOVE_THREAT_SEVERITY
DEF BOSSAI_EMIT_MOVE_TIER_ROLL_THRESHOLDS EQU 1
INCLUDE "engine/battle/ai/boss_policy_move.asm"
PURGE BOSSAI_EMIT_MOVE_TIER_ROLL_THRESHOLDS
DEF BOSSAI_EMIT_PLATFORM_SCOUTED_BITMAP_IO EQU 1
INCLUDE "engine/battle/ai/boss_platform.asm"
PURGE BOSSAI_EMIT_PLATFORM_SCOUTED_BITMAP_IO
DEF BOSSAI_EMIT_MOVE_SCOUT_DECISION EQU 1
INCLUDE "engine/battle/ai/boss_policy_move.asm"
PURGE BOSSAI_EMIT_MOVE_SCOUT_DECISION
DEF BOSSAI_EMIT_PLATFORM_REPEAT_TRACKER EQU 1
INCLUDE "engine/battle/ai/boss_platform.asm"
PURGE BOSSAI_EMIT_PLATFORM_REPEAT_TRACKER
DEF BOSSAI_EMIT_MOVE_MARK_SCOUTED_IF_SCOUT_MOVE EQU 1
INCLUDE "engine/battle/ai/boss_policy_move.asm"
PURGE BOSSAI_EMIT_MOVE_MARK_SCOUTED_IF_SCOUT_MOVE
DEF BOSSAI_EMIT_SWITCH_CANDIDATE_RISK_REFINEMENT EQU 1
INCLUDE "engine/battle/ai/boss_policy_switch.asm"
PURGE BOSSAI_EMIT_SWITCH_CANDIDATE_RISK_REFINEMENT
DEF BOSSAI_EMIT_SWITCH_CONFIDENCE_FINALIZATION EQU 1
INCLUDE "engine/battle/ai/boss_policy_switch.asm"
PURGE BOSSAI_EMIT_SWITCH_CONFIDENCE_FINALIZATION
DEF BOSSAI_EMIT_MOVE_MARK_SCOUT_PIVOT EQU 1
INCLUDE "engine/battle/ai/boss_policy_move.asm"
PURGE BOSSAI_EMIT_MOVE_MARK_SCOUT_PIVOT
DEF BOSSAI_EMIT_PLATFORM_NO_CHEAT_TABLES EQU 1
INCLUDE "engine/battle/ai/boss_platform.asm"
PURGE BOSSAI_EMIT_PLATFORM_NO_CHEAT_TABLES
DEF BOSSAI_EMIT_MOVE_BIAS_SUPPORT_TABLES EQU 1
INCLUDE "engine/battle/ai/boss_policy_move.asm"
PURGE BOSSAI_EMIT_MOVE_BIAS_SUPPORT_TABLES
