...
DEF BOSSAI_HAKI_SCORING_CONTEXT_F EQU 3
...
; / GetPrimaryThreatType / PublicEnemyFaster / GetProjectionDepth). Inputs to
; each are stable within one tick; first call computes, the rest read from
; cache. Sentinel is $ff for all — the GetPrimaryThreatType wrapper
; distinguishes "no threat" via a separate $20+ band since real type ids cap
; at $1b.
	ld a, $ff
