...
Route31MailRecipientScript:
	faceplayer
	opentext
	checkevent EVENT_GOT_TM_REST_FROM_ROUTE31
	iftrue .DescribeRest
...
.TryGiveKenya:
	...
	setevent EVENT_GOT_TM_REST_FROM_ROUTE31
.DescribeRest:
	writetext Text_Route31DescribeRest
	waitbutton
.NoRoomForItems:
	closetext
	end
